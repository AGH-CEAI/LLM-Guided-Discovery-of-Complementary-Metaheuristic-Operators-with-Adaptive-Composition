...
- AdaptiveDEWithRestarts
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 8.565223e-04
  from lineage 2, cycle 5
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: SOLVED  (error=1.00e-08)
  Task  2: SOLVED  (error=1.00e-08)
  Task  3: error=1.345e-04
  Task  4: SOLVED  (error=1.00e-08)
  Task  5: SOLVED  (error=1.00e-08)
  Task  6: SOLVED  (error=5.69e-08)
  Task  7: error=4.036e-06
  Task  8: SOLVED  (error=1.00e-08)
  Task  9: error=1.956e-04
  Task 10: SOLVED  (error=1.00e-08)
  Task 11: error=2.634e+00  *** NEEDS IMPROVEMENT ***
  Task 12: error=4.286e-06
  Task 13: error=1.197e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.471e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=1.149e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=9.686e+01  *** NEEDS IMPROVEMENT ***
  Task 17: error=3.120e+00  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.671e+00  *** NEEDS IMPROVEMENT ***
  Task 19: error=6.742e+00  *** NEEDS IMPROVEMENT ***
  Task 20: error=1.213e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.403e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=2.306e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=1.565e+01  *** NEEDS IMPROVEMENT ***

History stats: 6 cycles, 3 improvements, 0 crashes
Methods that responded well to adaptation:
  - _restart (1 successful adaptation(s))
  - _detect_stagnation (1 successful adaptation(s))
  - _generate_parameters_batch (1 successful adaptation(s))
