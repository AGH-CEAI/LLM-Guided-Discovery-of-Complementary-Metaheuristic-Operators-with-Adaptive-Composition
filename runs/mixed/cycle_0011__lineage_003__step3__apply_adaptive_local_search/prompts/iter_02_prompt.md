This is iteration 2 of 10. Propose ONE replacement implementation for `_apply_adaptive_local_search`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task 16: *** UNSOLVED *** — best=6.026e+02 by original.py               (target=1e-08, ~+10.8 decades above target)
  ...
  Task  4: *** UNSOLVED *** — best=1.252e+00 by original.py               (target=1e-08, ~+8.1 decades above target)
  ...
  Task 17: *** UNSOLVED *** — best=5.438e-08 by original.py               (target=1e-08, ~+0.7 decades above target)
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  ...
  Task 16: best error so far = 6.026e+02  (target = 1e-08)
