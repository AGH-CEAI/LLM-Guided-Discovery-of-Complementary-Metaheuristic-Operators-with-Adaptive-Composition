This is iteration 3 of 10. Propose ONE replacement implementation for `_adapt_parameters_batch`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 12: *** UNSOLVED *** — best=1.613e+03 by original.py               (target=1e-08, ~+11.2 decades above target)
  Task  8: *** UNSOLVED *** — best=9.816e+02 by original.py               (target=1e-08, ~+11.0 decades above target)
  Task 16: *** UNSOLVED *** — best=6.001e+02 by original.py               (target=1e-08, ~+10.8 decades above target)
  Task 21: *** UNSOLVED *** — best=5.000e+01 by original.py               (target=1e-08, ~+9.7 decades above target)
  Task 13: *** UNSOLVED *** — best=3.198e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 14: *** UNSOLVED *** — best=5.969e+00 by original.py               (target=1e-08, ~+8.8 decades above target)
  ...
  Task  5: *** UNSOLVED *** — best=1.400e+00 by original.py               (target=1e-08, ~+8.1 decades above target)
  Task  4: *** UNSOLVED *** — best=1.236e+00 by original.py               (target=1e-08, ~+8.1 decades above target)
  Task  1: *** UNSOLVED *** — best=3.433e-01 by original.py               (target=1e-08, ~+7.5 decades above target)
  Task 19: *** UNSOLVED *** — best=2.058e-02 by original.py               (target=1e-08, ~+6.3 decades above target)
  Task 22: *** UNSOLVED *** — best=9.460e-04 by original.py               (target=1e-08, ~+5.0 decades above target)
  Task 18: *** UNSOLVED *** — best=9.392e-04 by original.py               (target=1e-08, ~+5.0 decades above target)
  Task 11: *** UNSOLVED *** — best=4.273e-05 by original.py               (target=1e-08, ~+3.6 decades above target)
  Task 10: *** UNSOLVED *** — best=3.328e-05 by original.py               (target=1e-08, ~+3.5 decades above target)
  Task  9: *** UNSOLVED *** — best=2.661e-06 by original.py               (target=1e-08, ~+2.4 decades above target)
  Task  6: *** UNSOLVED *** — best=2.389e-07 by original.py               (target=1e-08, ~+1.4 decades above target)
  Task  7: *** UNSOLVED *** — best=1.521e-07 by original.py               (target=1e-08, ~+1.2 decades above target)
  Task  2: *** UNSOLVED *** — best=7.263e-08 by original.py               (target=1e-08, ~+0.9 decades above target)
  Task 17: *** UNSOLVED *** — best=3.821e-08 by original.py               (target=1e-08, ~+0.6 decades above target)
  Task  3: *** UNSOLVED *** — best=2.719e-08 by original.py               (target=1e-08, ~+0.4 decades above target)
  Task 15: *** UNSOLVED *** — best=2.000e-08 by original.py               (target=1e-08, ~+0.3 decades above target)
...
-----------------------------------------------------------------------
0    1.0000e-08            -inf                  -inf                  
1    3.4333e-01            -inf                  -inf                  
2    7.2629e-08            -inf                  -inf                  
3    2.7188e-08            -inf                  -inf                  
4    1.2359e+00            -inf                  -inf                  
5    1.4004e+00            -inf                  -inf                  
6    2.3889e-07            -inf                  -inf                  
7    1.5207e-07            -inf                  -inf                  
8    9.8156e+02            -inf                  -inf                  
9    2.6612e-06            -inf                  -inf                  
10   3.3276e-05            -inf                  -inf                  
11   4.2728e-05            -inf                  -inf                  
12   1.6127e+03            -inf                  -inf                  
13   3.1977e+01            -inf                  -inf                  
14   5.9694e+00            -inf                  -inf                  
15   2.0000e-08            -inf                  -inf                  
16   6.0010e+02            -inf                  -inf                  
17   3.8210e-08            -inf                  -inf                  
18   9.3917e-04            -inf                  -inf                  
19   2.0579e-02            -inf                  -inf                  
20   5.0000e+00            -inf                  -inf                  
21   5.0001e+01            -inf                  -inf                  
22   9.4596e-04            -inf                  -inf                  
23   2.3053e+00            -inf                  -inf                  

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 12: best error so far = 1.613e+03  (target = 1e-08)
  Task  8: best error so far = 9.816e+02  (target = 1e-08)
  Task 16: best error so far = 6.001e+02  (target = 1e-08)
  Task 21: best error so far = 5.000e+01  (target = 1e-08)
  Task 13: best error so far = 3.198e+01  (target = 1e-08)
  Task 14: best error so far = 5.969e+00  (target = 1e-08)
