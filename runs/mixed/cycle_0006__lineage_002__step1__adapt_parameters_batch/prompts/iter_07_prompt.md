This is iteration 7 of 10. Propose ONE replacement implementation for `_adapt_parameters_batch`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task 16: *** UNSOLVED *** — best=5.871e+02 by variant_03_idea_0.py      (target=1e-08, ~+10.8 decades above target)
  ...
  Task 13: *** UNSOLVED *** — best=3.308e+00 by variant_03_idea_0.py      (target=1e-08, ~+8.5 decades above target)
  Task 23: *** UNSOLVED *** — best=2.305e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  5: *** UNSOLVED *** — best=1.226e+00 by variant_03_idea_0.py      (target=1e-08, ~+8.1 decades above target)
  Task  4: *** UNSOLVED *** — best=7.732e-01 by variant_03_idea_0.py      (target=1e-08, ~+7.9 decades above target)
  Task  1: *** UNSOLVED *** — best=3.394e-01 by variant_03_idea_0.py      (target=1e-08, ~+7.5 decades above target)
  Task 19: *** UNSOLVED *** — best=2.844e-03 by variant_03_idea_0.py      (target=1e-08, ~+5.5 decades above target)
  Task 22: *** UNSOLVED *** — best=3.642e-05 by variant_03_idea_0.py      (target=1e-08, ~+3.6 decades above target)
  Task 10: *** UNSOLVED *** — best=1.703e-06 by variant_03_idea_0.py      (target=1e-08, ~+2.2 decades above target)
  Task 11: *** UNSOLVED *** — best=1.644e-06 by variant_03_idea_0.py      (target=1e-08, ~+2.2 decades above target)
  Task 18: *** UNSOLVED *** — best=1.632e-06 by variant_03_idea_0.py      (target=1e-08, ~+2.2 decades above target)
  Task  9: *** UNSOLVED *** — best=8.969e-08 by variant_03_idea_0.py      (target=1e-08, ~+1.0 decades above target)
  ...
  Task  3: *** UNSOLVED *** — best=1.227e-08 by variant_03_idea_0.py      (target=1e-08, ~+0.1 decades above target)
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.0000e-08            -inf                  -inf                  1.0000e-08            -inf                  1.0000e-08            -inf                  
1    3.4333e-01            -inf                  -inf                  3.3939e-01            -inf                  3.4001e-01            -inf                  
2    7.2629e-08            -inf                  -inf                  1.0000e-08            -inf                  9.5236e-02            -inf                  
3    2.7188e-08            -inf                  -inf                  1.2269e-08            -inf                  5.5517e-06            -inf                  
4    1.2359e+00            -inf                  -inf                  7.7321e-01            -inf                  1.5835e+00            -inf                  
5    1.4004e+00            -inf                  -inf                  1.2263e+00            -inf                  1.7365e+00            -inf                  
6    2.3889e-07            -inf                  -inf                  1.0000e-08            -inf                  2.0934e-01            -inf                  
7    1.5207e-07            -inf                  -inf                  1.0000e-08            -inf                  4.7143e-01            -inf                  
8    9.8156e+02            -inf                  -inf                  8.4589e+02            -inf                  1.4567e+03            -inf                  
9    2.6612e-06            -inf                  -inf                  8.9686e-08            -inf                  1.2473e+01            -inf                  
10   3.3276e-05            -inf                  -inf                  1.7031e-06            -inf                  3.5538e+02            -inf                  
11   4.2728e-05            -inf                  -inf                  1.6442e-06            -inf                  4.5012e+02            -inf                  
12   1.6127e+03            -inf                  -inf                  1.2127e+03            -inf                  1.5198e+03            -inf                  
13   3.1977e+01            -inf                  -inf                  3.3076e+00            -inf                  4.9953e+03            -inf                  
14   5.9694e+00            -inf                  -inf                  5.8309e+00            -inf                  5.9990e+00            -inf                  
15   2.0000e-08            -inf                  -inf                  1.3333e-08            -inf                  4.0000e-08            -inf                  
16   6.0010e+02            -inf                  -inf                  5.8711e+02            -inf                  6.1893e+02            -inf                  
17   3.8210e-08            -inf                  -inf                  4.9979e-07            -inf                  6.2752e+02            -inf                  
18   9.3917e-04            -inf                  -inf                  1.6320e-06            -inf                  2.1957e+03            -inf                  
19   2.0579e-02            -inf                  -inf                  2.8439e-03            -inf                  3.4594e+00            -inf                  
20   5.0000e+00            -inf                  -inf                  5.0000e+00            -inf                  5.1291e+00            -inf                  
21   5.0001e+01            -inf                  -inf                  5.0000e+01            -inf                  4.6332e+02            -inf                  
22   9.4596e-04            -inf                  -inf                  3.6419e-05            -inf                  6.5535e+00            -inf                  
23   2.3053e+00            -inf                  -inf                  4.0175e+00            -inf                  5.3338e+01            -inf                  
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  ...
  Task 16: best error so far = 5.871e+02  (target = 1e-08)
  ...
  Task 13: best error so far = 3.308e+00  (target = 1e-08)
