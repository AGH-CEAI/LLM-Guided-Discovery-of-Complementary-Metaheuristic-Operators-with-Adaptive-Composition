This is iteration 10 of 10. Propose ONE replacement implementation for `_adapt_parameters_batch`.

Requirements:
- Keep the EXACT function signature: `def _adapt_parameters_batch(self, population, fitness, mutants, trials):`
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 12: *** UNSOLVED *** — best=1.213e+03 by variant_03_idea_0.py      (target=1e-08, ~+11.1 decades above target)
  Task  8: *** UNSOLVED *** — best=8.459e+02 by variant_03_idea_0.py      (target=1e-08, ~+10.9 decades above target)
  Task 16: *** UNSOLVED *** — best=5.846e+02 by variant_07_idea_0.py      (target=1e-08, ~+10.8 decades above target)
  Task 21: *** UNSOLVED *** — best=5.000e+01 by variant_03_idea_0.py      (target=1e-08, ~+9.7 decades above target)
  Task 14: *** UNSOLVED *** — best=5.831e+00 by variant_03_idea_0.py      (target=1e-08, ~+8.8 decades above target)
  Task 20: *** UNSOLVED *** — best=5.000e+00 by variant_07_idea_0.py      (target=1e-08, ~+8.7 decades above target)
  Task 23: *** UNSOLVED *** — best=2.305e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task 13: *** UNSOLVED *** — best=1.813e+00 by variant_07_idea_0.py      (target=1e-08, ~+8.3 decades above target)
  Task  5: *** UNSOLVED *** — best=1.141e+00 by variant_07_idea_0.py      (target=1e-08, ~+8.1 decades above target)
  Task  4: *** UNSOLVED *** — best=7.732e-01 by variant_03_idea_0.py      (target=1e-08, ~+7.9 decades above target)
  Task  1: *** UNSOLVED *** — best=3.392e-01 by variant_07_idea_0.py      (target=1e-08, ~+7.5 decades above target)
  Task 19: *** UNSOLVED *** — best=7.457e-04 by variant_07_idea_0.py      (target=1e-08, ~+4.9 decades above target)
  Task 22: *** UNSOLVED *** — best=4.621e-06 by variant_07_idea_0.py      (target=1e-08, ~+2.7 decades above target)
  Task 18: *** UNSOLVED *** — best=1.632e-06 by variant_03_idea_0.py      (target=1e-08, ~+2.2 decades above target)
  Task 17: *** UNSOLVED *** — best=3.821e-08 by original.py               (target=1e-08, ~+0.6 decades above target)
  Task 11: *** UNSOLVED *** — best=3.494e-08 by variant_07_idea_0.py      (target=1e-08, ~+0.5 decades above target)
  Task 10: *** UNSOLVED *** — best=1.895e-08 by variant_07_idea_0.py      (target=1e-08, ~+0.3 decades above target)
...
SOLVED TASKS (already at or below target — do not regress these):
  ...
  Task  2: SOLVED  — best=1.000e-08 by variant_03_idea_0.py          
  Task  3: SOLVED  — best=1.000e-08 by variant_07_idea_0.py          
  Task  6: SOLVED  — best=1.000e-08 by variant_03_idea_0.py          
  Task  7: SOLVED  — best=1.000e-08 by variant_03_idea_0.py          
  Task  9: SOLVED  — best=1.000e-08 by variant_07_idea_0.py          
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.0000e-08            -inf                  1.0000e-08            -inf                  1.0000e-08            -inf                  1.0000e-08            -inf                  -inf                  
1    3.4333e-01            -inf                  3.3939e-01            -inf                  3.4001e-01            -inf                  3.3917e-01            -inf                  -inf                  
2    7.2629e-08            -inf                  1.0000e-08            -inf                  9.5236e-02            -inf                  1.0000e-08            -inf                  -inf                  
3    2.7188e-08            -inf                  1.2269e-08            -inf                  5.5517e-06            -inf                  1.0000e-08            -inf                  -inf                  
4    1.2359e+00            -inf                  7.7321e-01            -inf                  1.5835e+00            -inf                  8.7311e-01            -inf                  -inf                  
5    1.4004e+00            -inf                  1.2263e+00            -inf                  1.7365e+00            -inf                  1.1412e+00            -inf                  -inf                  
6    2.3889e-07            -inf                  1.0000e-08            -inf                  2.0934e-01            -inf                  1.0000e-08            -inf                  -inf                  
7    1.5207e-07            -inf                  1.0000e-08            -inf                  4.7143e-01            -inf                  1.0000e-08            -inf                  -inf                  
8    9.8156e+02            -inf                  8.4589e+02            -inf                  1.4567e+03            -inf                  1.1901e+03            -inf                  -inf                  
9    2.6612e-06            -inf                  8.9686e-08            -inf                  1.2473e+01            -inf                  1.0000e-08            -inf                  -inf                  
10   3.3276e-05            -inf                  1.7031e-06            -inf                  3.5538e+02            -inf                  1.8955e-08            -inf                  -inf                  
11   4.2728e-05            -inf                  1.6442e-06            -inf                  4.5012e+02            -inf                  3.4940e-08            -inf                  -inf                  
12   1.6127e+03            -inf                  1.2127e+03            -inf                  1.5198e+03            -inf                  1.8026e+03            -inf                  -inf                  
13   3.1977e+01            -inf                  3.3076e+00            -inf                  4.9953e+03            -inf                  1.8131e+00            -inf                  -inf                  
14   5.9694e+00            -inf                  5.8309e+00            -inf                  5.9990e+00            -inf                  5.9740e+00            -inf                  -inf                  
15   2.0000e-08            -inf                  1.3333e-08            -inf                  4.0000e-08            -inf                  5.4563e+02            -inf                  -inf                  
16   6.0010e+02            -inf                  5.8711e+02            -inf                  6.1893e+02            -inf                  5.8456e+02            -inf                  -inf                  
17   3.8210e-08            -inf                  4.9979e-07            -inf                  6.2752e+02            -inf                  5.2960e+02            -inf                  -inf                  
18   9.3917e-04            -inf                  1.6320e-06            -inf                  2.1957e+03            -inf                  5.4138e+02            -inf                  -inf                  
19   2.0579e-02            -inf                  2.8439e-03            -inf                  3.4594e+00            -inf                  7.4571e-04            -inf                  -inf                  
20   5.0000e+00            -inf                  5.0000e+00            -inf                  5.1291e+00            -inf                  5.0000e+00            -inf                  -inf                  
21   5.0001e+01            -inf                  5.0000e+01            -inf                  4.6332e+02            -inf                  5.0000e+01            -inf                  -inf                  
22   9.4596e-04            -inf                  3.6419e-05            -inf                  6.5535e+00            -inf                  4.6213e-06            -inf                  -inf                  
23   2.3053e+00            -inf                  4.0175e+00            -inf                  5.3338e+01            -inf                  6.2645e+00            -inf                  -inf                  

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 12: best error so far = 1.213e+03  (target = 1e-08)
  Task  8: best error so far = 8.459e+02  (target = 1e-08)
  Task 16: best error so far = 5.846e+02  (target = 1e-08)
  Task 21: best error so far = 5.000e+01  (target = 1e-08)
  Task 14: best error so far = 5.831e+00  (target = 1e-08)
  Task 20: best error so far = 5.000e+00  (target = 1e-08)
  Task 23: best error so far = 2.305e+00  (target = 1e-08)
  Task 13: best error so far = 1.813e+00  (target = 1e-08)
