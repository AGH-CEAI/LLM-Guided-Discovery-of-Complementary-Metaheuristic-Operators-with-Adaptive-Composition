...
CANDIDATE methods (you MUST pick exactly 3 distinct names from this list):
  - _initialize_population  (2 LOC)
  - _init_parameters  (2 LOC)
  - _argmin  (2 LOC)
  - _init_velocity  (3 LOC)
  - _eval_wrapper  (3 LOC)
  - _init_archive  (4 LOC)
  - _crossover_batch  (7 LOC)
  - _compute_diversity  (7 LOC)
  - _build_trials_batched  (9 LOC)
  - _restart_if_stagnant  (12 LOC)
  - _find_unique_solutions  (13 LOC)
  - _update_velocity_batch  (16 LOC)
  - _apply_adaptive_local_search  (22 LOC)
  - _mutate_current_to_pbest_with_culture  (26 LOC)
  - _select_survivors_batch  (28 LOC)
  - _update_archive_batch  (53 LOC)
...
(no prior cycles in this lineage)
  ...
  Global pick counts so far (method: count):
    ...
    _apply_adaptive_local_search: 1
    _argmin: 1
    _compute_reward: 1
    _eval_wrapper: 1
    ...
    _mutate_original: 1
    _mutate_variant09: 1
    _restart_if_stagnant: 1
    _select_survivors_batch: 1
    _update_archive_batch: 1
