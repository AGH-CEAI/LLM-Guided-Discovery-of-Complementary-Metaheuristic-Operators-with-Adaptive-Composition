...
- CulturalDifferentialEvolution
- AdaptiveRingParticleSwarm
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.339692e-04
  from lineage 4, cycle 12
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: error=2.405e-01
  Task  2: SOLVED  (error=1.00e-08)
  Task  3: SOLVED  (error=1.00e-08)
  Task  4: error=1.305e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=1.185e+00  *** NEEDS IMPROVEMENT ***
  Task  6: SOLVED  (error=1.00e-08)
  Task  7: SOLVED  (error=1.00e-08)
  Task  8: error=2.205e+03  *** NEEDS IMPROVEMENT ***
  Task  9: SOLVED  (error=1.00e-08)
  Task 10: SOLVED  (error=1.00e-08)
  Task 11: SOLVED  (error=1.00e-08)
  Task 12: error=3.198e+03  *** NEEDS IMPROVEMENT ***
  Task 13: error=2.817e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=6.484e+00  *** NEEDS IMPROVEMENT ***
  Task 15: SOLVED  (error=1.00e-08)
  Task 16: SOLVED  (error=1.33e-08)
  Task 17: SOLVED  (error=1.00e-08)
  Task 18: SOLVED  (error=1.33e-08)
  Task 19: error=7.583e-04
  Task 20: error=5.000e+00  *** NEEDS IMPROVEMENT ***
  Task 21: error=5.000e+01  *** NEEDS IMPROVEMENT ***
  Task 22: error=9.855e-06
  Task 23: error=7.022e+00  *** NEEDS IMPROVEMENT ***

History stats: 15 cycles, 10 improvements, 0 crashes
Methods that responded well to adaptation:
  ...
  - _update_archive_batch (1 successful adaptation(s))
