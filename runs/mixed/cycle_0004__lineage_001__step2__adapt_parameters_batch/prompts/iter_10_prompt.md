...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 12: *** UNSOLVED *** — best=1.552e+03 by variant_07_idea_0.py      (target=1e-08, ~+11.2 decades above target)
  Task  8: *** UNSOLVED *** — best=1.088e+03 by variant_07_idea_0.py      (target=1e-08, ~+11.0 decades above target)
  Task 21: *** UNSOLVED *** — best=5.000e+01 by original.py               (target=1e-08, ~+9.7 decades above target)
  Task 13: *** UNSOLVED *** — best=4.590e+01 by original.py               (target=1e-08, ~+9.7 decades above target)
  Task 14: *** UNSOLVED *** — best=5.857e+00 by original.py               (target=1e-08, ~+8.8 decades above target)
  Task 20: *** UNSOLVED *** — best=5.000e+00 by original.py               (target=1e-08, ~+8.7 decades above target)
  Task 23: *** UNSOLVED *** — best=2.510e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  5: *** UNSOLVED *** — best=1.367e+00 by original.py               (target=1e-08, ~+8.1 decades above target)
  Task  4: *** UNSOLVED *** — best=1.271e+00 by variant_07_idea_0.py      (target=1e-08, ~+8.1 decades above target)
  Task  1: *** UNSOLVED *** — best=3.413e-01 by original.py               (target=1e-08, ~+7.5 decades above target)
  Task 16: *** UNSOLVED *** — best=4.014e-02 by variant_05_idea_0.py      (target=1e-08, ~+6.6 decades above target)
  Task 19: *** UNSOLVED *** — best=1.823e-02 by original.py               (target=1e-08, ~+6.3 decades above target)
  Task 22: *** UNSOLVED *** — best=9.574e-04 by original.py               (target=1e-08, ~+5.0 decades above target)
  Task 18: *** UNSOLVED *** — best=2.723e-04 by original.py               (target=1e-08, ~+4.4 decades above target)
  Task 10: *** UNSOLVED *** — best=3.598e-05 by original.py               (target=1e-08, ~+3.6 decades above target)
  Task 11: *** UNSOLVED *** — best=3.222e-05 by original.py               (target=1e-08, ~+3.5 decades above target)
  Task  9: *** UNSOLVED *** — best=3.695e-06 by original.py               (target=1e-08, ~+2.6 decades above target)
  Task 17: *** UNSOLVED *** — best=1.849e-06 by original.py               (target=1e-08, ~+2.3 decades above target)
  Task  7: *** UNSOLVED *** — best=2.769e-07 by original.py               (target=1e-08, ~+1.4 decades above target)
  Task  6: *** UNSOLVED *** — best=1.322e-07 by original.py               (target=1e-08, ~+1.1 decades above target)
  Task  2: *** UNSOLVED *** — best=6.067e-08 by original.py               (target=1e-08, ~+0.8 decades above target)
  Task  3: *** UNSOLVED *** — best=3.052e-08 by original.py               (target=1e-08, ~+0.5 decades above target)

SOLVED TASKS (already at or below target — do not regress these):
  Task  0: SOLVED  — best=1.000e-08 by original.py                   
  Task 15: SOLVED  — best=1.000e-08 by variant_07_idea_0.py          
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------