...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 12: *** UNSOLVED *** — best=2.263e+03 by variant_01_idea_0.py      (target=1e-08, ~+11.4 decades above target)
  Task  8: *** UNSOLVED *** — best=4.597e+02 by variant_01_idea_0.py      (target=1e-08, ~+10.7 decades above target)
  Task 16: *** UNSOLVED *** — best=2.229e+02 by variant_02_idea_0.py      (target=1e-08, ~+10.3 decades above target)
  Task 13: *** UNSOLVED *** — best=1.968e+02 by variant_01_idea_0.py      (target=1e-08, ~+10.3 decades above target)
  Task  2: *** UNSOLVED *** — best=6.600e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.8 decades above target)
  Task 21: *** UNSOLVED *** — best=6.141e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.8 decades above target)
  Task 23: *** UNSOLVED *** — best=3.751e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.6 decades above target)
  Task 18: *** UNSOLVED *** — best=7.256e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.9 decades above target)
  Task 20: *** UNSOLVED *** — best=5.684e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.8 decades above target)
  Task 14: *** UNSOLVED *** — best=5.436e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.7 decades above target)
  Task 17: *** UNSOLVED *** — best=4.926e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.7 decades above target)
  Task  3: *** UNSOLVED *** — best=2.955e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task  5: *** UNSOLVED *** — best=1.933e+00 by original.py               (target=1e-08, ~+8.3 decades above target)
  Task  4: *** UNSOLVED *** — best=1.812e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.3 decades above target)
  Task 19: *** UNSOLVED *** — best=9.904e-01 by variant_01_idea_0.py      (target=1e-08, ~+8.0 decades above target)
  Task  1: *** UNSOLVED *** — best=9.705e-01 by variant_01_idea_0.py      (target=1e-08, ~+8.0 decades above target)
  Task 22: *** UNSOLVED *** — best=9.146e-01 by variant_01_idea_0.py      (target=1e-08, ~+8.0 decades above target)
  Task 11: *** UNSOLVED *** — best=8.060e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.9 decades above target)
  Task 10: *** UNSOLVED *** — best=8.051e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.9 decades above target)
  Task 15: *** UNSOLVED *** — best=7.632e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.9 decades above target)
  Task  7: *** UNSOLVED *** — best=7.204e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.9 decades above target)
  Task  9: *** UNSOLVED *** — best=6.497e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.8 decades above target)
  Task  6: *** UNSOLVED *** — best=5.804e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.8 decades above target)
  Task  0: *** UNSOLVED *** — best=4.818e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.7 decades above target)

PER-TASK BENCHMARK ERRORS (raw numbers, lower is better):
Task original.py           variant_01_idea_0.py  variant_02_idea_0.py  
-----------------------------------------------------------------------
0    5.0641e-01            4.8178e-01            1.0233e+00            
1    9.7110e-01            9.7047e-01            1.0020e+00            
2    2.1086e+04            6.5995e+01            2.9345e+04            
3    2.9553e+00            3.0166e+00            6.7095e+00            
4    1.8181e+00            1.8120e+00            1.8876e+00            
5    1.9327e+00            1.9543e+00            1.9862e+00            
6    7.3677e-01            5.8042e-01            1.5570e+00            
7    7.9918e-01            7.2037e-01            1.3734e+00            
8    6.0777e+02            4.5969e+02            7.2459e+02            
9    1.1093e+00            6.4968e-01            6.2144e+02            
10   1.1843e+01            8.0512e-01            5.4529e+03            
11   2.9487e+00            8.0604e-01            4.6402e+03            
12   2.9767e+03            2.2632e+03            9.5857e+03            
13   2.1242e+03            1.9679e+02            8.3151e+03            
14   5.6346e+00            5.4364e+00            5.7554e+00            
15   1.4140e+00            7.6320e-01            7.5658e+00            
16   7.3523e+02            7.2492e+02            2.2295e+02            
17   3.4115e+02            4.9262e+00            5.9308e+03            
18   6.1411e+02            7.2562e+00            3.5589e+03            
19   4.5711e+00            9.9043e-01            1.2966e+01            
20   5.7468e+00            5.7318e+00            5.6840e+00            
21   1.7418e+03            6.1412e+01            1.2604e+04            
22   9.8645e-01            9.1464e-01            2.7558e+01            
23   6.1696e+01            3.7508e+01            9.6574e+01            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 12: best error so far = 2.263e+03  (target = 1e-08)
  Task  8: best error so far = 4.597e+02  (target = 1e-08)
  Task 16: best error so far = 2.229e+02  (target = 1e-08)
  Task 13: best error so far = 1.968e+02  (target = 1e-08)
  Task  2: best error so far = 6.600e+01  (target = 1e-08)
  Task 21: best error so far = 6.141e+01  (target = 1e-08)
  Task 23: best error so far = 3.751e+01  (target = 1e-08)
  Task 18: best error so far = 7.256e+00  (target = 1e-08)
