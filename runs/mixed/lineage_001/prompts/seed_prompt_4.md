...
- CovarianceGuidedDE
- ArchipelagoDifferentialParticleSwarm
- QuantumTopologyParticleSwarm
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 3.792593e-01
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: error=2.422e-01
  Task  2: error=1.285e+01  *** NEEDS IMPROVEMENT ***
  Task  3: SOLVED  (error=1.00e-08)
  Task  4: error=1.105e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=1.179e+00  *** NEEDS IMPROVEMENT ***
  Task  6: error=5.145e-03
  Task  7: error=3.129e-03
  Task  8: error=5.520e+02  *** NEEDS IMPROVEMENT ***
  Task  9: error=4.359e-02
  Task 10: error=4.110e-02
  Task 11: error=2.383e-01
  Task 12: error=1.859e+03  *** NEEDS IMPROVEMENT ***
  Task 13: error=3.975e+02  *** NEEDS IMPROVEMENT ***
  Task 14: error=5.366e+00  *** NEEDS IMPROVEMENT ***
  Task 15: SOLVED  (error=1.88e-08)
  Task 16: error=5.349e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=4.173e+02  *** NEEDS IMPROVEMENT ***
  Task 18: error=5.796e+02  *** NEEDS IMPROVEMENT ***
  Task 19: error=5.789e-01
  Task 20: error=5.156e+00  *** NEEDS IMPROVEMENT ***
  Task 21: error=1.130e+02  *** NEEDS IMPROVEMENT ***
  Task 22: error=2.992e-01
  Task 23: error=5.235e+01  *** NEEDS IMPROVEMENT ***
