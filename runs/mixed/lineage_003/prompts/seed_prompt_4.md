...
- AdaptiveCulturalDE
- CovarianceMemeticOptimizer
- HybridParticleSwarmCultural
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 5.711425e-04
  from lineage 2, cycle 8
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: error=2.988e-01
  Task  2: SOLVED  (error=1.03e-08)
  Task  3: SOLVED  (error=1.41e-08)
  Task  4: error=1.185e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=1.438e+00  *** NEEDS IMPROVEMENT ***
  Task  6: SOLVED  (error=1.04e-08)
  Task  7: SOLVED  (error=3.12e-08)
  Task  8: error=1.939e+02  *** NEEDS IMPROVEMENT ***
  Task  9: SOLVED  (error=2.10e-08)
  Task 10: error=1.416e-07
  Task 11: SOLVED  (error=5.45e-08)
  Task 12: error=4.103e+02  *** NEEDS IMPROVEMENT ***
  Task 13: error=3.955e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=5.258e+00  *** NEEDS IMPROVEMENT ***
  Task 15: SOLVED  (error=4.00e-08)
  Task 16: error=6.009e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=1.158e-07
  Task 18: error=2.429e-07
  Task 19: error=1.249e-03
  Task 20: error=5.000e+00  *** NEEDS IMPROVEMENT ***
  Task 21: error=5.000e+01  *** NEEDS IMPROVEMENT ***
  Task 22: error=1.690e-05
  Task 23: error=6.335e+00  *** NEEDS IMPROVEMENT ***

History stats: 9 cycles, 7 improvements, 0 crashes
