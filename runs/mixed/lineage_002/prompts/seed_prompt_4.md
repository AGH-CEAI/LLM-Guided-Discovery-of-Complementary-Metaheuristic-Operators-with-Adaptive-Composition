...
- CulturalDifferentialEvolutionWithVelocity
- CovarianceRingAdaptationOptimizer
- QuantumCulturalSwarmOptimizer
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 3.686177e-03
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: error=3.413e-01
  Task  2: SOLVED  (error=6.07e-08)
  Task  3: SOLVED  (error=3.05e-08)
  Task  4: error=1.304e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=1.367e+00  *** NEEDS IMPROVEMENT ***
  Task  6: error=1.322e-07
  Task  7: error=2.769e-07
  Task  8: error=1.172e+03  *** NEEDS IMPROVEMENT ***
  Task  9: error=3.695e-06
  Task 10: error=3.598e-05
  Task 11: error=3.222e-05
  Task 12: error=1.612e+03  *** NEEDS IMPROVEMENT ***
  Task 13: error=4.590e+01  *** NEEDS IMPROVEMENT ***
  Task 14: error=5.857e+00  *** NEEDS IMPROVEMENT ***
  Task 15: SOLVED  (error=1.33e-08)
  Task 16: error=6.001e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=1.849e-06
  Task 18: error=2.723e-04
  Task 19: error=1.823e-02
  Task 20: error=5.000e+00  *** NEEDS IMPROVEMENT ***
  Task 21: error=5.000e+01  *** NEEDS IMPROVEMENT ***
  Task 22: error=9.574e-04
  Task 23: error=2.510e+00  *** NEEDS IMPROVEMENT ***

History stats: 6 cycles, 4 improvements, 0 crashes
Methods that responded well to adaptation:
  - _eval_wrapper (1 successful adaptation(s))
  - _clip_to_bounds_batch (1 successful adaptation(s))
