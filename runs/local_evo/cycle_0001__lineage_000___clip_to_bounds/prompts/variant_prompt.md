Below is a metaheuristic optimizer. Propose 8 DISTINCT replacement implementations for `_clip_to_bounds`.

Requirements:
- Keep the EXACT function signature: `def _clip_to_bounds(self, candidates):`
