Below is a metaheuristic optimizer. Propose 8 DISTINCT replacement implementations for `_select_indices`.

Requirements:
- Keep the EXACT function signature: `def _select_indices(self):`
