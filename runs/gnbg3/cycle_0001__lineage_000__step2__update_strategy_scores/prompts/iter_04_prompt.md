...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 21
...
CURRENT VARIANTS' PERFORMANCE ON TASK 21 (lower = better):
  original.py                               5.2889e+00
  variant_01_catA_t10_idea_0.py             5.1765e+00
  variant_02_catB_t09_idea_0.py             5.2744e+00

HISTORICAL BEST on task 21 across the entire run: 4.8596e+00  (achieved by `original.py` in a previous cycle).
...
that has a real chance of beating 4.860e+00 on task 21 (the run-history best from `original.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 21).
```python
