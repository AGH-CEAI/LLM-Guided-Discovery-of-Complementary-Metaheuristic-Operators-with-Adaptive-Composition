...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 4
...
CURRENT VARIANTS' PERFORMANCE ON TASK 4 (lower = better):
  original.py                               2.0000e-08
  variant_01_catA_t10_idea_0.py             1.6876e-02
  variant_02_catB_t09_idea_0.py             4.0000e-08
  variant_05_catE_t14_idea_0.py             1.6326e-02

HISTORICAL BEST on task 4 across the entire run: 2.0000e-08  (achieved by `variant_05_catE_t10_idea_0.py` in a previous cycle).
...
that has a real chance of beating 2.000e-08 on task 4 (the run-history best from `variant_05_catE_t10_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category F: Temporal / dynamical and target task 4).
```python
