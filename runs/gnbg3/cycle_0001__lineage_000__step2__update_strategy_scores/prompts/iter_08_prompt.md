This is iteration 8 of 10. Propose ONE replacement implementation for `_update_strategy_scores`.
...
CURRENT VARIANTS' PERFORMANCE ON TASK 12 (lower = better):
  ...
  variant_07_catG_t12_idea_0.py             1.1133e+01
...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×1  B×1  C×0  D×0  E×1  F×1  G×1  H×0

YOUR TASK:
Write a fundamentally new implementation of `_update_strategy_scores` that, working
through the lens of your assigned category 'Hybrid / multi-strategy', is a candidate
...
**Idea: Short Name**
One-line description (must mention category H: Hybrid / multi-strategy and target task 12).
```python
