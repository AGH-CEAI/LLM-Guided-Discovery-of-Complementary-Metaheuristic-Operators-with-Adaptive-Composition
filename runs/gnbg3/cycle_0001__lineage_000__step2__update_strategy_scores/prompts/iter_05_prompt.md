...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 14
...
CURRENT VARIANTS' PERFORMANCE ON TASK 14 (lower = better):
  original.py                               8.2270e+00
  variant_01_catA_t10_idea_0.py             8.8385e+00
  variant_02_catB_t09_idea_0.py             8.8945e+00

HISTORICAL BEST on task 14 across the entire run: 4.8785e+00  (achieved by `original.py` in a previous cycle).
...
that has a real chance of beating 4.878e+00 on task 14 (the run-history best from `original.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category E: Topology / graph-based and target task 14).
```python
