This is iteration 7 of 10. Propose ONE replacement implementation for `_update_strategy_scores`.
...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 12
...
CURRENT VARIANTS' PERFORMANCE ON TASK 12 (lower = better):
  original.py                               1.1889e-01
  variant_01_catA_t10_idea_0.py             2.6705e+01
  variant_02_catB_t09_idea_0.py             4.3824e+01
  variant_05_catE_t14_idea_0.py             1.5920e+01
  variant_06_catF_t04_idea_0.py             9.0348e+00

HISTORICAL BEST on task 12 across the entire run: 1.1889e-01  (achieved by `variant_05_catE_t10_idea_0.py` in a previous cycle).
...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×1  B×1  C×0  D×0  E×1  F×1  G×0  H×0
...
that has a real chance of beating 1.189e-01 on task 12 (the run-history best from `variant_05_catE_t10_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category G: Stochastic / sampling-based and target task 12).
```python
