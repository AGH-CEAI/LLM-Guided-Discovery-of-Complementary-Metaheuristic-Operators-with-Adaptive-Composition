...
CURRENT VARIANTS' PERFORMANCE ON TASK 19 (lower = better):
  ...
  variant_01_catA_t06_idea_0.py             3.5302e+01
  variant_03_catC_t22_idea_0.py             3.6214e+01
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 19).
```python
