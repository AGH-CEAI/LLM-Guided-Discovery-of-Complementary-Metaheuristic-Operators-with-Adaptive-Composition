This is iteration 9 of 10. Propose ONE replacement implementation for `_update_strategy_scores`.
...
- Keep the EXACT function signature: `def _update_strategy_scores(self, strategy_used, improved):`
...
CURRENT VARIANTS' PERFORMANCE ON TASK 17 (lower = better):
  original.py                               1.5436e+01
  variant_01_catA_t06_idea_0.py             4.5514e+02
  variant_03_catC_t22_idea_0.py             3.3731e+03
  variant_04_catD_t19_idea_0.py             3.4020e+02
  variant_06_catF_t17_idea_0.py             2.2930e+03
  variant_08_catH_t17_idea_0.py             3.8794e+02

HISTORICAL BEST on task 17 across the entire run: 6.6140e+00  (achieved by `variant_01_catA_t11_idea_0.py` in a previous cycle).
...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×1  B×0  C×1  D×1  E×0  F×1  G×0  H×1

YOUR TASK:
Write a fundamentally new implementation of `_update_strategy_scores` that, working
through the lens of your assigned category 'Geometry / spatial', is a candidate
that has a real chance of beating 6.614e+00 on task 17 (the run-history best from `variant_01_catA_t11_idea_0.py`). It is acceptable for your variant to be WORSE than
...
Full algorithm for context (the body of `_update_strategy_scores` has been STUBBED OUT
...
class AdaptiveCompassDE:
    ...
    def _update_strategy_scores(self, strategy_used, improved):
        ...
        # [STUB — your job is to write the body of `_update_strategy_scores` from scratch.
