This is iteration 5 of 10. Propose ONE replacement implementation for `_update_strategy_scores`.
...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 15
...
CURRENT VARIANTS' PERFORMANCE ON TASK 15 (lower = better):
  original.py                               1.7219e+00
  variant_01_catA_t06_idea_0.py             2.1603e+00
  variant_03_catC_t22_idea_0.py             2.2928e+00
  variant_04_catD_t19_idea_0.py             2.3844e+00

HISTORICAL BEST on task 15 across the entire run: 1.5257e+00  (achieved by `variant_05_catE_t13_idea_0.py` in a previous cycle).
...
that has a real chance of beating 1.526e+00 on task 15 (the run-history best from `variant_05_catE_t13_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category E: Topology / graph-based and target task 15).
```python
