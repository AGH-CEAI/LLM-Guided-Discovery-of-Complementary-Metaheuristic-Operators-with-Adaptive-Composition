This is iteration 1 of 10. Propose ONE replacement implementation for `_check_stagnation`.
...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 8
...
CURRENT VARIANTS' PERFORMANCE ON TASK 8 (lower = better):
  original.py                               3.0044e-02

HISTORICAL BEST on task 8 across the entire run: 2.4493e-02  (achieved by `variant_08_catH_t12_idea_0.py` in a previous cycle).
...
that has a real chance of beating 2.449e-02 on task 8 (the run-history best from `variant_08_catH_t12_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category A: Geometry / spatial and target task 8).
```python
