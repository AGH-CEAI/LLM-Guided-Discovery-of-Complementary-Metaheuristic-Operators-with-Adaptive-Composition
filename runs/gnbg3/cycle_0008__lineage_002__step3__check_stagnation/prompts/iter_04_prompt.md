...
CURRENT VARIANTS' PERFORMANCE ON TASK 6 (lower = better):
  original.py                               4.4452e+01
  variant_01_catA_t08_idea_0.py             3.5973e+01
  variant_02_catB_t15_idea_0.py             4.0266e+01
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 6).
```python
