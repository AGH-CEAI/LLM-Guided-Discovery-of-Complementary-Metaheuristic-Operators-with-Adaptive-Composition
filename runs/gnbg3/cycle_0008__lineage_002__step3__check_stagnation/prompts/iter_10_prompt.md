...
CURRENT VARIANTS' PERFORMANCE ON TASK 17 (lower = better):
  ...
  variant_09_catA_t17_idea_0.py             1.5267e+02
...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×2  B×1  C×0  D×1  E×1  F×1  G×1  H×1

YOUR TASK:
Write a fundamentally new implementation of `_check_stagnation` that, working
through the lens of your assigned category 'Spectral / linear-algebraic', is a candidate
...
**Idea: Short Name**
One-line description (must mention category B: Spectral / linear-algebraic and target task 17).
```python
