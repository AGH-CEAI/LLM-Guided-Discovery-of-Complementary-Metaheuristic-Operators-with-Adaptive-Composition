...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×1  B×1  C×0  D×1  E×1  F×1  G×0  H×0

YOUR TASK:
Write a fundamentally new implementation of `_check_stagnation` that, working
through the lens of your assigned category 'Stochastic / sampling-based', is a candidate
...
**Idea: Short Name**
One-line description (must mention category G: Stochastic / sampling-based and target task 17).
```python
