...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 23
...
CURRENT VARIANTS' PERFORMANCE ON TASK 23 (lower = better):
  original.py                               3.0853e+01
  variant_01_catA_t08_idea_0.py             3.3112e+01
  variant_02_catB_t15_idea_0.py             3.5405e+01
  variant_04_catD_t06_idea_0.py             3.7155e+01

HISTORICAL BEST on task 23 across the entire run: 7.8154e+00  (achieved by `variant_02_catB_t21_idea_0.py` in a previous cycle).
...
that has a real chance of beating 7.815e+00 on task 23 (the run-history best from `variant_02_catB_t21_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category E: Topology / graph-based and target task 23).
```python
