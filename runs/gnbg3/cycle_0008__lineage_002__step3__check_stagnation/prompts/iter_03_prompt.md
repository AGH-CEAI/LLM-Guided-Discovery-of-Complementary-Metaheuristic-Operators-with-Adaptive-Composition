...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 7
...
CURRENT VARIANTS' PERFORMANCE ON TASK 7 (lower = better):
  original.py                               6.7465e-02
  variant_01_catA_t08_idea_0.py             7.0733e-02
  variant_02_catB_t15_idea_0.py             5.5492e-02

HISTORICAL BEST on task 7 across the entire run: 2.9388e-02  (achieved by `variant_06_catF_t05_idea_0.py` in a previous cycle).
...
that has a real chance of beating 2.939e-02 on task 7 (the run-history best from `variant_06_catF_t05_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category C: Information-theoretic / distributional and target task 7).
```python
