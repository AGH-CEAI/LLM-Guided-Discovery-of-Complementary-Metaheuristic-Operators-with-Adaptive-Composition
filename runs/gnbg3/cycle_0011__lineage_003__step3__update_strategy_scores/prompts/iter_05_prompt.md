...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 18
...
CURRENT VARIANTS' PERFORMANCE ON TASK 18 (lower = better):
  original.py                               2.4683e+01
  variant_01_catA_t05_idea_0.py             2.6578e+01
  variant_02_catB_t13_idea_0.py             1.9808e+01
  variant_04_catD_t16_idea_0.py             2.1492e+01

HISTORICAL BEST on task 18 across the entire run: 1.8705e+01  (achieved by `variant_06_catF_t05_idea_0.py` in a previous cycle).
...
that has a real chance of beating 1.871e+01 on task 18 (the run-history best from `variant_06_catF_t05_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category E: Topology / graph-based and target task 18).
```python
