This is iteration 4 of 10. Propose ONE replacement implementation for `_update_strategy_scores`.
...
CURRENT VARIANTS' PERFORMANCE ON TASK 16 (lower = better):
  original.py                               6.5138e+02
  variant_01_catA_t05_idea_0.py             8.5552e+02
  variant_02_catB_t13_idea_0.py             9.4829e+02
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 16).
```python
