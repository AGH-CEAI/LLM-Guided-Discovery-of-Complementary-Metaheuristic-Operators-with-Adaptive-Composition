...
CURRENT VARIANTS' PERFORMANCE ON TASK 5 (lower = better):
  ...
  variant_01_catA_t05_idea_0.py             1.2495e-04
  variant_02_catB_t13_idea_0.py             3.2283e-04
  variant_04_catD_t16_idea_0.py             7.4767e-04
  variant_05_catE_t18_idea_0.py             5.1592e-04
  variant_06_catF_t05_idea_0.py             7.9265e-05
...
**Idea: Short Name**
One-line description (must mention category G: Stochastic / sampling-based and target task 5).
```python
