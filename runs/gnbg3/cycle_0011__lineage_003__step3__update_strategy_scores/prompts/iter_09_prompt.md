...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 10
...
CURRENT VARIANTS' PERFORMANCE ON TASK 10 (lower = better):
  original.py                               1.1416e-06
  variant_01_catA_t05_idea_0.py             1.1067e-04
  variant_02_catB_t13_idea_0.py             9.8744e-05
  variant_04_catD_t16_idea_0.py             8.2006e-05
  variant_05_catE_t18_idea_0.py             1.0401e-04
  variant_06_catF_t05_idea_0.py             8.7569e-06
  variant_07_catG_t05_idea_0.py             1.3125e-06
  variant_08_catH_t10_idea_0.py             1.3144e-04

HISTORICAL BEST on task 10 across the entire run: 1.1270e-07  (achieved by `original.py` in a previous cycle).
...
that has a real chance of beating 1.127e-07 on task 10 (the run-history best from `original.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category A: Geometry / spatial and target task 10).
```python
