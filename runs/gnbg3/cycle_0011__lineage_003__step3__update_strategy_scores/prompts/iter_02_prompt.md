This is iteration 2 of 10. Propose ONE replacement implementation for `_update_strategy_scores`.
...
CURRENT VARIANTS' PERFORMANCE ON TASK 13 (lower = better):
  original.py                               2.4542e+00
  variant_01_catA_t05_idea_0.py             4.1680e+00
...
**Idea: Short Name**
One-line description (must mention category B: Spectral / linear-algebraic and target task 13).
```python
