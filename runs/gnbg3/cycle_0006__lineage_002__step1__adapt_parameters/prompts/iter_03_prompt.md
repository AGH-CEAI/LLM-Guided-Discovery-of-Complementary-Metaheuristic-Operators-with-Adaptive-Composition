...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 1
...
CURRENT VARIANTS' PERFORMANCE ON TASK 1 (lower = better):
  original.py                               8.1690e-06
  variant_02_catB_t12_idea_0.py             2.7389e+00

HISTORICAL BEST on task 1 across the entire run: 3.3213e-06  (achieved by `variant_06_catF_t04_idea_0.py` in a previous cycle).
...
that has a real chance of beating 3.321e-06 on task 1 (the run-history best from `variant_06_catF_t04_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category C: Information-theoretic / distributional and target task 1).
```python
