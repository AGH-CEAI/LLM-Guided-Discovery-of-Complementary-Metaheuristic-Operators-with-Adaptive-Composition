...
CURRENT VARIANTS' PERFORMANCE ON TASK 14 (lower = better):
  original.py                               3.7646e+00
  variant_02_catB_t12_idea_0.py             4.4805e+00
  variant_03_catC_t01_idea_0.py             6.1992e+00
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 14).
```python
