This is iteration 1 of 10. Propose ONE replacement implementation for `_adapt_parameters`.
...
**Idea: Short Name**
One-line description (must mention category A: Geometry / spatial and target task 16).
```python
