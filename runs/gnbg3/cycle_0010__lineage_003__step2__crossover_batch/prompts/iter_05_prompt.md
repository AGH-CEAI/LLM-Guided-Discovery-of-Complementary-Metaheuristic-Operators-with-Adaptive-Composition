...
- Keep the EXACT function signature: `def _crossover_batch(self, population, mutants):`
...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 11
...
CURRENT VARIANTS' PERFORMANCE ON TASK 11 (lower = better):
  original.py                               1.2535e+01
  variant_01_catA_t19_idea_0.py             1.8726e+01
  variant_02_catB_t23_idea_0.py             5.1653e+01
  variant_04_catD_t23_idea_0.py             2.2262e+02

HISTORICAL BEST on task 11 across the entire run: 9.9117e+00  (achieved by `variant_01_catA_t11_idea_0.py` in a previous cycle).
...
YOUR TASK:
Write a fundamentally new implementation of `_crossover_batch` that, working
through the lens of your assigned category 'Topology / graph-based', is a candidate
that has a real chance of beating 9.912e+00 on task 11 (the run-history best from `variant_01_catA_t11_idea_0.py`). It is acceptable for your variant to be WORSE than
...
Full algorithm for context (the body of `_crossover_batch` has been STUBBED OUT
...
class AdaptiveCompassDE:
    ...
    def _crossover_batch(self, population, mutants):
        ...
        # [STUB — your job is to write the body of `_crossover_batch` from scratch.
...
**Idea: Short Name**
One-line description (must mention category E: Topology / graph-based and target task 11).
```python
