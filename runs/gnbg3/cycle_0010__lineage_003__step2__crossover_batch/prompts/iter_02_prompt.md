...
CURRENT VARIANTS' PERFORMANCE ON TASK 23 (lower = better):
  original.py                               3.5920e+01
  variant_01_catA_t19_idea_0.py             3.2402e+01
...
**Idea: Short Name**
One-line description (must mention category B: Spectral / linear-algebraic and target task 23).
```python
