This is iteration 1 of 10. Propose ONE replacement implementation for `_crossover_batch`.
...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 19
...
CURRENT VARIANTS' PERFORMANCE ON TASK 19 (lower = better):
  original.py                               3.6096e+01

HISTORICAL BEST on task 19 across the entire run: 2.9864e+01  (achieved by `variant_06_catF_t05_idea_0.py` in a previous cycle).
...
that has a real chance of beating 2.986e+01 on task 19 (the run-history best from `variant_06_catF_t05_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category A: Geometry / spatial and target task 19).
```python
