...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 3
Fallback random pick (variance metric unavailable).
═══════════════════════════════════════════════════════════════════════

CURRENT VARIANTS' PERFORMANCE ON TASK 3 (lower = better):
  original.py                               1.2236e+00

HISTORICAL BEST on task 3 across the entire run: 6.5788e-02  (achieved by `variant_02_catB_t21_idea_0.py` in a previous cycle).
...
that has a real chance of beating 6.579e-02 on task 3 (the run-history best from `variant_02_catB_t21_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category G: Stochastic / sampling-based and target task 3).
```python
