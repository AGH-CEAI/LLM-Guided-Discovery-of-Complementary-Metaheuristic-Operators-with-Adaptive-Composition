...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 20
...
CURRENT VARIANTS' PERFORMANCE ON TASK 20 (lower = better):
  original.py                               1.7929e+01

HISTORICAL BEST on task 20 across the entire run: 9.4508e+00  (achieved by `variant_02_catB_t21_idea_0.py` in a previous cycle).
...
that has a real chance of beating 9.451e+00 on task 20 (the run-history best from `variant_02_catB_t21_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category B: Spectral / linear-algebraic and target task 20).
```python
