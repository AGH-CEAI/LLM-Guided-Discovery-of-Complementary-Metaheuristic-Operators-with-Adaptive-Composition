...
- AdaptiveCompositeDE
- CovarianceGuidedMemeticOptimizer
- TopologyAdaptiveParticleSwarm
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 6.400299e-02
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: error=4.643e-06
  Task  2: SOLVED  (error=1.00e-08)
  Task  3: error=1.505e+00  *** NEEDS IMPROVEMENT ***
  Task  4: SOLVED  (error=1.00e-08)
  Task  5: error=2.913e-05
  Task  6: error=3.771e+01  *** NEEDS IMPROVEMENT ***
  Task  7: error=3.544e-02
  Task  8: error=2.498e-02
  Task  9: error=9.271e+00  *** NEEDS IMPROVEMENT ***
  Task 10: error=1.313e-06
  Task 11: error=9.597e+00  *** NEEDS IMPROVEMENT ***
  Task 12: error=7.775e-03
  Task 13: error=2.640e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=4.034e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=1.476e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=4.965e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=4.729e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.342e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=4.039e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=1.526e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.566e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=4.287e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=3.471e+01  *** NEEDS IMPROVEMENT ***

History stats: 12 cycles, 5 improvements, 0 crashes
Methods that responded well to adaptation:
  - _update_strategy_scores (2 successful adaptation(s))
  - _adapt_parameters (1 successful adaptation(s))
  - _restart_if_needed (1 successful adaptation(s))
