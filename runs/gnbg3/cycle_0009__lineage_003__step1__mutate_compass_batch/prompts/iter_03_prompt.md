...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 2
...
CURRENT VARIANTS' PERFORMANCE ON TASK 2 (lower = better):
  original.py                               1.0000e-08
  variant_01_catA_t22_idea_0.py             7.0908e-04

HISTORICAL BEST on task 2 across the entire run: 1.0000e-08  (achieved by `variant_01_catA_t16_idea_0.py` in a previous cycle).
...
that has a real chance of beating 1.000e-08 on task 2 (the run-history best from `variant_01_catA_t16_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category C: Information-theoretic / distributional and target task 2).
```python
