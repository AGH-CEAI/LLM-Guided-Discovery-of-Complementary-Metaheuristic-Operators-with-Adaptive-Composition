...
CURRENT VARIANTS' PERFORMANCE ON TASK 10 (lower = better):
  ...
  variant_01_catA_t22_idea_0.py             2.3129e+01
  variant_03_catC_t02_idea_0.py             1.0174e+01
...
**Idea: Short Name**
One-line description (must mention category E: Topology / graph-based and target task 10).
```python
