...
CURRENT VARIANTS' PERFORMANCE ON TASK 18 (lower = better):
  ...
  variant_01_catA_t22_idea_0.py             3.6257e+01
  variant_03_catC_t02_idea_0.py             2.9775e+01
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 18).
```python
