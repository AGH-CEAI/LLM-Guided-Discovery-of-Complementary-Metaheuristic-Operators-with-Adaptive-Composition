This is iteration 1 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 22
...
CURRENT VARIANTS' PERFORMANCE ON TASK 22 (lower = better):
  original.py                               6.1425e+00

HISTORICAL BEST on task 22 across the entire run: 4.1370e+00  (achieved by `variant_06_catF_t05_idea_0.py` in a previous cycle).
...
that has a real chance of beating 4.137e+00 on task 22 (the run-history best from `variant_06_catF_t05_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category A: Geometry / spatial and target task 22).
```python
