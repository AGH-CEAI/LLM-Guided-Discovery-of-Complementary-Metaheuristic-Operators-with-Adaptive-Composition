...
- CovarianceMemeticRingOptimizer
- AdaptiveTopologySwarmOptimizer
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 6.552219e-02
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: error=5.969e-06
  Task  2: SOLVED  (error=1.00e-08)
  Task  3: error=8.914e-01
  Task  4: SOLVED  (error=1.00e-08)
  Task  5: error=2.399e-05
  Task  6: error=3.919e+01  *** NEEDS IMPROVEMENT ***
  Task  7: error=4.485e-02
  Task  8: error=2.918e-02
  Task  9: error=9.132e+00  *** NEEDS IMPROVEMENT ***
  Task 10: error=1.337e-06
  Task 11: error=1.048e+01  *** NEEDS IMPROVEMENT ***
  Task 12: error=2.868e-02
  Task 13: error=2.447e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=4.119e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=1.526e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=8.089e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=1.363e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.080e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=3.451e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=1.673e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.683e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=5.435e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=3.148e+01  *** NEEDS IMPROVEMENT ***
