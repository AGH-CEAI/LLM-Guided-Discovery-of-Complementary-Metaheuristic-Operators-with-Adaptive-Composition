...
- AdaptiveCompositeDERing
- ArchipelagoCMAES
- AdaptiveMultiStrategyPSO
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 6.444338e-02
  from lineage 1, cycle 3
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  1: error=4.733e-06
  Task  2: SOLVED  (error=1.00e-08)
  Task  3: error=9.212e-01
  Task  4: SOLVED  (error=1.00e-08)
  Task  5: error=2.157e-05
  Task  6: error=3.270e+01  *** NEEDS IMPROVEMENT ***
  Task  7: error=6.173e-02
  Task  8: error=3.057e-02
  Task  9: error=9.313e+00  *** NEEDS IMPROVEMENT ***
  Task 10: error=2.735e-06
  Task 11: error=1.508e+01  *** NEEDS IMPROVEMENT ***
  Task 12: error=8.127e-03
  Task 13: error=2.527e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=3.510e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=1.722e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=8.320e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=1.544e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.038e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=3.343e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=1.659e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.633e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=4.805e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=2.946e+01  *** NEEDS IMPROVEMENT ***

History stats: 6 cycles, 3 improvements, 0 crashes
Methods that responded well to adaptation:
  - _adapt_parameters (1 successful adaptation(s))
  - _update_strategy_scores (1 successful adaptation(s))
