...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 9
...
CURRENT VARIANTS' PERFORMANCE ON TASK 9 (lower = better):
  original.py                               9.3129e+00
  variant_01_catA_t16_idea_0.py             1.4787e+02
  variant_02_catB_t21_idea_0.py             1.7129e+00
  variant_03_catC_t14_idea_0.py             1.1279e+02

HISTORICAL BEST on task 9 across the entire run: 1.7129e+00  (achieved by `variant_02_catB_t21_idea_0.py` in a previous cycle).
...
that has a real chance of beating 1.713e+00 on task 9 (the run-history best from `variant_02_catB_t21_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category E: Topology / graph-based and target task 9).
```python
