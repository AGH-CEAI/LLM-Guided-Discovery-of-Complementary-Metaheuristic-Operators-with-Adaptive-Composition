...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 6
...
CURRENT VARIANTS' PERFORMANCE ON TASK 6 (lower = better):
  original.py                               4.3582e+01
  variant_01_catA_t11_idea_0.py             3.6934e+01

HISTORICAL BEST on task 6 across the entire run: 3.6934e+01  (achieved by `variant_01_catA_t11_idea_0.py` in a previous cycle).
...
that has a real chance of beating 3.693e+01 on task 6 (the run-history best from `variant_01_catA_t11_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category C: Information-theoretic / distributional and target task 6).
```python
