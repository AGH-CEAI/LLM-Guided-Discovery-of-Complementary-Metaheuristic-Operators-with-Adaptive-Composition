...
CURRENT VARIANTS' PERFORMANCE ON TASK 19 (lower = better):
  original.py                               1.4841e+02
  variant_01_catA_t11_idea_0.py             1.4540e+02
...
**Idea: Short Name**
One-line description (must mention category B: Spectral / linear-algebraic and target task 19).
```python
