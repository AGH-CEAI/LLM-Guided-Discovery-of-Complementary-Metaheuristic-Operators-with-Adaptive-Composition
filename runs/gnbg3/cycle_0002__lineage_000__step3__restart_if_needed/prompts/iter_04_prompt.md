...
CURRENT VARIANTS' PERFORMANCE ON TASK 1 (lower = better):
  original.py                               5.5306e-06
  variant_01_catA_t11_idea_0.py             3.7633e-06
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 1).
```python
