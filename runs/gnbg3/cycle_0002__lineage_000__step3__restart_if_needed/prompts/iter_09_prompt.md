...
- Keep the EXACT function signature: `def _restart_if_needed(self, population, fitness):`
...
CURRENT VARIANTS' PERFORMANCE ON TASK 17 (lower = better):
  original.py                               6.0836e+03
  variant_01_catA_t11_idea_0.py             6.6140e+00
  variant_05_catE_t13_idea_0.py             1.3633e+01
  variant_07_catG_t17_idea_0.py             2.6314e+02
...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×1  B×0  C×0  D×0  E×1  F×0  G×1  H×0

YOUR TASK:
Write a fundamentally new implementation of `_restart_if_needed` that, working
...
Full algorithm for context (the body of `_restart_if_needed` has been STUBBED OUT
...
class AdaptiveCompassDE:
    ...
    def _restart_if_needed(self, population, fitness):
        ...
        # [STUB — your job is to write the body of `_restart_if_needed` from scratch.
