This is iteration 10 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
CURRENT VARIANTS' PERFORMANCE ON TASK 5 (lower = better):
  ...
  variant_09_catA_t05_idea_0.py             2.0133e+02
...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×2  B×1  C×1  D×0  E×1  F×1  G×0  H×0
...
**Idea: Short Name**
One-line description (must mention category B: Spectral / linear-algebraic and target task 5).
```python
