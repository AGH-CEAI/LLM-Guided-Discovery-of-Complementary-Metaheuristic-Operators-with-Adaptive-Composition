This is iteration 8 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
**Idea: Short Name**
One-line description (must mention category H: Hybrid / multi-strategy and target task 5).
```python
