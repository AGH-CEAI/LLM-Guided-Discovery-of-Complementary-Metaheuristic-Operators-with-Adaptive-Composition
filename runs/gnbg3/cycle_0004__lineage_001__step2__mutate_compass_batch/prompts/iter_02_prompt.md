This is iteration 2 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
**Idea: Short Name**
One-line description (must mention category B: Spectral / linear-algebraic and target task 16).
```python
