This is iteration 4 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
CURRENT VARIANTS' PERFORMANCE ON TASK 11 (lower = better):
  original.py                               1.5076e+01
  variant_01_catA_t13_idea_0.py             3.6984e+02
  variant_02_catB_t16_idea_0.py             2.9232e+02
  variant_03_catC_t19_idea_0.py             2.1470e+02
...
through the lens of your assigned category 'Fitness-landscape / rank-based', is a candidate
...
**Idea: Short Name**
One-line description (must mention category D: Fitness-landscape / rank-based and target task 11).
```python
