This is iteration 3 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
CURRENT VARIANTS' PERFORMANCE ON TASK 19 (lower = better):
  original.py                               3.3429e+01
  variant_01_catA_t13_idea_0.py             7.7959e+01
  variant_02_catB_t16_idea_0.py             1.7174e+02
...
through the lens of your assigned category 'Information-theoretic / distributional', is a candidate
...
**Idea: Short Name**
One-line description (must mention category C: Information-theoretic / distributional and target task 19).
```python
