...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 13
...
CURRENT VARIANTS' PERFORMANCE ON TASK 13 (lower = better):
  original.py                               2.5273e+00

HISTORICAL BEST on task 13 across the entire run: 2.0336e+00  (achieved by `variant_05_catE_t09_idea_0.py` in a previous cycle).
...
that has a real chance of beating 2.034e+00 on task 13 (the run-history best from `variant_05_catE_t09_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category A: Geometry / spatial and target task 13).
```python
