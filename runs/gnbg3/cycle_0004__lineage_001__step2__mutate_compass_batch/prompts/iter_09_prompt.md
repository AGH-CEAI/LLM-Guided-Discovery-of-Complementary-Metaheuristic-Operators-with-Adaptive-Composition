This is iteration 9 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
═══════════════════════════════════════════════════════════════════════
FOCUS TASK FOR THIS ITERATION: task 5
...
CURRENT VARIANTS' PERFORMANCE ON TASK 5 (lower = better):
  original.py                               2.1565e-05
  variant_01_catA_t13_idea_0.py             5.1619e+02
  variant_02_catB_t16_idea_0.py             1.0959e+03
  variant_03_catC_t19_idea_0.py             1.3107e+04
  variant_05_catE_t16_idea_0.py             2.4567e+03
  variant_06_catF_t05_idea_0.py             1.1878e+02

HISTORICAL BEST on task 5 across the entire run: 2.2507e-06  (achieved by `variant_06_catF_t05_idea_0.py` in a previous cycle).
...
that has a real chance of beating 2.251e-06 on task 5 (the run-history best from `variant_06_catF_t05_idea_0.py`). It is acceptable for your variant to be WORSE than
...
**Idea: Short Name**
One-line description (must mention category A: Geometry / spatial and target task 5).
```python
