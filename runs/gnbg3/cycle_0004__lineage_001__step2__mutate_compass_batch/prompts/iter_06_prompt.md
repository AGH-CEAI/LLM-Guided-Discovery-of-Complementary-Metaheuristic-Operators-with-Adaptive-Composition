This is iteration 6 of 10. Propose ONE replacement implementation for `_mutate_compass_batch`.
...
CATEGORY ROTATION SO FAR (per-category proposal count):
  A×1  B×1  C×1  D×0  E×1  F×0  G×0  H×0
...
**Idea: Short Name**
One-line description (must mention category F: Temporal / dynamical and target task 5).
```python
