...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 17: *** UNSOLVED *** — best=4.530e+04 by variant_02_catB_idea_0.py (target=1e-08, ~+12.7 decades above target)
  Task 16: *** UNSOLVED *** — best=1.615e+03 by variant_02_catB_idea_0.py (target=1e-08, ~+11.2 decades above target)
  Task  6: *** UNSOLVED *** — best=6.188e+02 by variant_01_catA_idea_0.py (target=1e-08, ~+10.8 decades above target)
  Task 11: *** UNSOLVED *** — best=1.693e+02 by variant_04_catD_idea_0.py (target=1e-08, ~+10.2 decades above target)
  Task 19: *** UNSOLVED *** — best=1.545e+02 by variant_02_catB_idea_0.py (target=1e-08, ~+10.2 decades above target)
  Task  9: *** UNSOLVED *** — best=9.577e+01 by variant_01_catA_idea_0.py (target=1e-08, ~+10.0 decades above target)
  Task 23: *** UNSOLVED *** — best=6.631e+01 by variant_03_catC_idea_0.py (target=1e-08, ~+9.8 decades above target)
  Task 12: *** UNSOLVED *** — best=5.307e+01 by variant_06_catF_idea_0.py (target=1e-08, ~+9.7 decades above target)
  Task 18: *** UNSOLVED *** — best=4.721e+01 by variant_03_catC_idea_0.py (target=1e-08, ~+9.7 decades above target)
  Task 20: *** UNSOLVED *** — best=2.547e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.4 decades above target)
  Task 13: *** UNSOLVED *** — best=1.707e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.2 decades above target)
  Task 22: *** UNSOLVED *** — best=1.329e+01 by variant_01_catA_idea_0.py (target=1e-08, ~+9.1 decades above target)
  Task 10: *** UNSOLVED *** — best=1.278e+01 by variant_03_catC_idea_0.py (target=1e-08, ~+9.1 decades above target)
  Task  7: *** UNSOLVED *** — best=1.112e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.0 decades above target)
  Task  5: *** UNSOLVED *** — best=9.406e+00 by variant_03_catC_idea_0.py (target=1e-08, ~+9.0 decades above target)
  Task 14: *** UNSOLVED *** — best=8.627e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.9 decades above target)
  Task  3: *** UNSOLVED *** — best=6.383e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.8 decades above target)
  Task 21: *** UNSOLVED *** — best=5.407e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.7 decades above target)
  Task 15: *** UNSOLVED *** — best=3.526e+00 by variant_04_catD_idea_0.py (target=1e-08, ~+8.5 decades above target)
  Task  1: *** UNSOLVED *** — best=3.148e+00 by variant_03_catC_idea_0.py (target=1e-08, ~+8.5 decades above target)
  Task  8: *** UNSOLVED *** — best=2.835e+00 by variant_01_catA_idea_0.py (target=1e-08, ~+8.5 decades above target)
  Task  4: *** UNSOLVED *** — best=1.162e+00 by variant_08_catH_idea_0.py (target=1e-08, ~+8.1 decades above target)
  Task  2: *** UNSOLVED *** — best=3.847e-01 by variant_02_catB_idea_0.py (target=1e-08, ~+7.6 decades above target)
  Task  0: *** UNSOLVED *** — best=1.531e-01 by variant_03_catC_idea_0.py (target=1e-08, ~+7.2 decades above target)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.7470e-01            1.5581e-01            1.6615e-01            1.5312e-01            1.6976e-01            -inf                  1.6607e-01            -inf                  1.7569e-01            
1    3.5180e+00            4.5647e+00            3.8706e+00            3.1484e+00            3.1625e+00            -inf                  3.3571e+00            -inf                  3.3900e+00            
2    4.1168e-01            4.8680e-01            3.8472e-01            4.5562e-01            4.2141e-01            -inf                  4.4168e-01            -inf                  4.1664e-01            
3    6.4395e+00            7.2142e+00            6.3830e+00            6.7123e+00            6.6749e+00            -inf                  6.6800e+00            -inf                  6.5067e+00            
4    1.1645e+00            1.2158e+00            1.2862e+00            1.1923e+00            1.2257e+00            -inf                  1.2380e+00            -inf                  1.1624e+00            
5    9.7014e+00            1.1778e+02            2.3208e+01            9.4058e+00            4.8900e+01            -inf                  7.0005e+01            -inf                  9.8772e+01            
6    7.3183e+02            6.1879e+02            6.9205e+02            7.2518e+02            7.0095e+02            -inf                  6.2438e+02            -inf                  7.4778e+02            
7    1.1730e+01            1.7450e+01            1.1115e+01            1.5214e+01            1.2573e+01            -inf                  1.3548e+01            -inf                  1.2329e+01            
8    2.8970e+00            2.8350e+00            2.9545e+00            3.0266e+00            2.9770e+00            -inf                  3.0450e+00            -inf                  3.0364e+00            
9    1.1310e+02            9.5772e+01            1.0581e+02            9.6942e+01            1.0309e+02            -inf                  1.0422e+02            -inf                  1.1028e+02            
10   2.5631e+01            1.7134e+01            1.4415e+01            1.2777e+01            2.0474e+01            -inf                  1.5383e+01            -inf                  1.6566e+01            
11   2.3278e+02            2.0818e+02            1.7720e+02            2.1619e+02            1.6935e+02            -inf                  2.0179e+02            -inf                  2.1659e+02            
12   6.7502e+01            6.0188e+01            5.5334e+01            6.8313e+01            6.6872e+01            -inf                  5.3071e+01            -inf                  7.5553e+01            
13   2.2671e+01            2.2839e+01            1.7066e+01            1.7069e+01            1.9727e+01            -inf                  2.1413e+01            -inf                  2.2773e+01            
14   1.0822e+01            1.0354e+01            8.6269e+00            9.9258e+00            1.0298e+01            -inf                  1.0431e+01            -inf                  1.0659e+01            
15   3.6268e+00            3.6823e+00            3.6516e+00            3.7570e+00            3.5257e+00            -inf                  3.6061e+00            -inf                  3.5602e+00            
16   2.5362e+03            2.0301e+03            1.6154e+03            2.1549e+03            2.3963e+03            -inf                  2.4602e+03            -inf                  2.7544e+03            
17   4.7778e+04            5.2268e+04            4.5299e+04            5.2626e+04            6.3908e+04            -inf                  5.4574e+04            -inf                  5.3451e+04            
18   4.8762e+01            4.9176e+01            4.8520e+01            4.7208e+01            5.2331e+01            -inf                  4.9277e+01            -inf                  4.8112e+01            
19   1.7334e+02            1.5937e+02            1.5447e+02            1.6528e+02            1.6208e+02            -inf                  1.6185e+02            -inf                  1.6951e+02            
20   2.7313e+01            2.7656e+01            2.5468e+01            2.5666e+01            2.6404e+01            -inf                  2.5975e+01            -inf                  2.6739e+01            
21   5.6185e+00            5.4391e+00            5.4073e+00            5.6578e+00            5.4753e+00            -inf                  5.5172e+00            -inf                  5.5973e+00            
22   1.3568e+01            1.3292e+01            1.3691e+01            1.3857e+01            1.4040e+01            -inf                  1.3561e+01            -inf                  1.4116e+01            
23   7.2533e+01            6.9207e+01            7.0187e+01            6.6314e+01            7.1953e+01            -inf                  6.9155e+01            -inf                  7.1079e+01            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 4.530e+04  (target = 1e-08)
  Task 16: best error so far = 1.615e+03  (target = 1e-08)
  Task  6: best error so far = 6.188e+02  (target = 1e-08)
  Task 11: best error so far = 1.693e+02  (target = 1e-08)
  Task 19: best error so far = 1.545e+02  (target = 1e-08)
  Task  9: best error so far = 9.577e+01  (target = 1e-08)
  Task 23: best error so far = 6.631e+01  (target = 1e-08)
  Task 12: best error so far = 5.307e+01  (target = 1e-08)
