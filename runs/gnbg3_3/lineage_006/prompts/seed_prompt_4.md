...
- AdaptiveHybridDEWithTemporalDrift
- CovarianceSwarmOptimizer
- QuantumSwarmOppositionRingOptimizer
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.333124e+01
  from lineage 5, cycle 14

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=1.407e-01
  Task  1: error=1.886e+00  *** NEEDS IMPROVEMENT ***
  Task  2: error=2.069e-01
  Task  3: error=5.508e+00  *** NEEDS IMPROVEMENT ***
  Task  4: error=1.292e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=3.911e+02  *** NEEDS IMPROVEMENT ***
  Task  6: error=5.372e+02  *** NEEDS IMPROVEMENT ***
  Task  7: error=6.699e+00  *** NEEDS IMPROVEMENT ***
  Task  8: error=2.560e+00  *** NEEDS IMPROVEMENT ***
  Task  9: error=4.203e+01  *** NEEDS IMPROVEMENT ***
  Task 10: error=2.485e-01
  Task 11: error=8.582e+01  *** NEEDS IMPROVEMENT ***
  Task 12: error=4.561e-01
  Task 13: error=1.850e+01  *** NEEDS IMPROVEMENT ***
  Task 14: error=8.656e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=3.200e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=7.721e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=1.847e+04  *** NEEDS IMPROVEMENT ***
  Task 18: error=3.493e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=9.076e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.054e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=5.405e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=1.126e+01  *** NEEDS IMPROVEMENT ***
  Task 23: error=5.955e+01  *** NEEDS IMPROVEMENT ***

History stats: 17 cycles, 10 improvements, 0 crashes
Methods that responded well to adaptation:
  - _position_update_temporal_drift (3 successful adaptation(s))
