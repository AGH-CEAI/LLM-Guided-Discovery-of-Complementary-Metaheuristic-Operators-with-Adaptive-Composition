...
CANDIDATE methods with metadata (you MUST pick exactly 3 distinct names):
  ...
  _position_update_batch                       hot_path     4    MODIFIES_distribution  in_main_loop  called_by=[__call__]
  _update_personal_best_batch                  leaf         5    in_main_loop  called_by=[__call__]
  _compute_diversity                           observer     5    in_main_loop  PURE_observer  called_by=[_adapt_inertia_weight, _adapt_neighborhood_size]
  ...
  _adaptive_coefficients                       observer     10   in_main_loop  PURE_observer  called_by=[_velocity_update_batch]
  _adapt_inertia_weight                        leaf         14   in_main_loop  called_by=[__call__]
  ...
  _restart_if_stagnant                         leaf         29   in_main_loop  called_by=[__call__]
  _velocity_update_batch                       control_flow 46   in_main_loop  called_by=[__call__]
