...
CANDIDATE methods with metadata (you MUST pick exactly 3 distinct names):
  ...
  _compute_diversity                           observer     5    in_main_loop  PURE_observer  called_by=[_compute_fingerprint, _adapt_neighborhood_size]
  ...
  _adapt_neighborhood_size                     leaf         8    in_main_loop  called_by=[__call__]
