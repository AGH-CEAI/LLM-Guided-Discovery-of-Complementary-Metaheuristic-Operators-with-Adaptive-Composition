...
- AdaptiveHybridDEWithVelocity
- CovarianceRankParticleSwarm
- AdaptiveTopologySwarm
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 2.291207e+01
  from lineage 3, cycle 10

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=1.679e-01
  Task  1: error=2.514e+00  *** NEEDS IMPROVEMENT ***
  Task  2: error=4.185e-01
  Task  3: error=6.664e+00  *** NEEDS IMPROVEMENT ***
  Task  4: error=1.269e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=1.957e+01  *** NEEDS IMPROVEMENT ***
  Task  6: error=7.181e+02  *** NEEDS IMPROVEMENT ***
  Task  7: error=1.075e+01  *** NEEDS IMPROVEMENT ***
  Task  8: error=2.977e+00  *** NEEDS IMPROVEMENT ***
  Task  9: error=1.064e+02  *** NEEDS IMPROVEMENT ***
  Task 10: error=1.712e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=2.095e+02  *** NEEDS IMPROVEMENT ***
  Task 12: error=5.956e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=1.404e+01  *** NEEDS IMPROVEMENT ***
  Task 14: error=8.839e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=3.678e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=1.139e+03  *** NEEDS IMPROVEMENT ***
  Task 17: error=5.411e+04  *** NEEDS IMPROVEMENT ***
  Task 18: error=5.148e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.580e+02  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.377e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=5.469e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=1.393e+01  *** NEEDS IMPROVEMENT ***
  Task 23: error=6.914e+01  *** NEEDS IMPROVEMENT ***

History stats: 11 cycles, 8 improvements, 0 crashes
