...
- AdaptiveVelocityGuidedDE
- CovarianceGuidedAdaptiveDE
- AdaptiveNeighborhoodPSO
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 2.325406e+01
  from lineage 2, cycle 7

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=1.662e-01
  Task  1: error=3.871e+00  *** NEEDS IMPROVEMENT ***
  Task  2: error=3.847e-01
  Task  3: error=6.383e+00  *** NEEDS IMPROVEMENT ***
  Task  4: error=1.286e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=2.321e+01  *** NEEDS IMPROVEMENT ***
  Task  6: error=6.920e+02  *** NEEDS IMPROVEMENT ***
  Task  7: error=1.112e+01  *** NEEDS IMPROVEMENT ***
  Task  8: error=2.954e+00  *** NEEDS IMPROVEMENT ***
  Task  9: error=1.058e+02  *** NEEDS IMPROVEMENT ***
  Task 10: error=1.441e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=1.772e+02  *** NEEDS IMPROVEMENT ***
  Task 12: error=5.533e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=1.707e+01  *** NEEDS IMPROVEMENT ***
  Task 14: error=8.627e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=3.652e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=1.615e+03  *** NEEDS IMPROVEMENT ***
  Task 17: error=4.530e+04  *** NEEDS IMPROVEMENT ***
  Task 18: error=4.852e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.545e+02  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.547e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=5.407e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=1.369e+01  *** NEEDS IMPROVEMENT ***
  Task 23: error=7.019e+01  *** NEEDS IMPROVEMENT ***

History stats: 8 cycles, 7 improvements, 0 crashes
Methods that responded well to adaptation:
  ...
  - _position_update_temporal_drift (1 successful adaptation(s))
