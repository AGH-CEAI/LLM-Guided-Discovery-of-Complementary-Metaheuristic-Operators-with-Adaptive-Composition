...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 17: *** UNSOLVED *** — best=2.370e+04 by original.py               (target=1e-08, ~+12.4 decades above target)
  Task  5: *** UNSOLVED *** — best=2.983e+03 by original.py               (target=1e-08, ~+11.5 decades above target)
  ...
  Task 19: *** UNSOLVED *** — best=8.351e+01 by original.py               (target=1e-08, ~+9.9 decades above target)
  Task 23: *** UNSOLVED *** — best=5.788e+01 by original.py               (target=1e-08, ~+9.8 decades above target)
  Task  9: *** UNSOLVED *** — best=5.025e+01 by original.py               (target=1e-08, ~+9.7 decades above target)
  ...
  Task 13: *** UNSOLVED *** — best=1.945e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 22: *** UNSOLVED *** — best=1.206e+01 by original.py               (target=1e-08, ~+9.1 decades above target)
  Task 14: *** UNSOLVED *** — best=7.857e+00 by original.py               (target=1e-08, ~+8.9 decades above target)
  Task  3: *** UNSOLVED *** — best=5.808e+00 by original.py               (target=1e-08, ~+8.8 decades above target)
  Task  7: *** UNSOLVED *** — best=5.754e+00 by original.py               (target=1e-08, ~+8.8 decades above target)
  Task 21: *** UNSOLVED *** — best=5.717e+00 by original.py               (target=1e-08, ~+8.8 decades above target)
  Task 15: *** UNSOLVED *** — best=3.072e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task  8: *** UNSOLVED *** — best=2.903e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task  1: *** UNSOLVED *** — best=1.820e+00 by original.py               (target=1e-08, ~+8.3 decades above target)
  Task  4: *** UNSOLVED *** — best=1.328e+00 by original.py               (target=1e-08, ~+8.1 decades above target)
  Task 12: *** UNSOLVED *** — best=4.800e-01 by original.py               (target=1e-08, ~+7.7 decades above target)
  Task 10: *** UNSOLVED *** — best=2.493e-01 by original.py               (target=1e-08, ~+7.4 decades above target)
  Task  2: *** UNSOLVED *** — best=2.010e-01 by original.py               (target=1e-08, ~+7.3 decades above target)
...
8    2.9032e+00            FAILED                
9    5.0254e+01            FAILED                
10   2.4930e-01            FAILED                
11   9.2454e+01            FAILED                
12   4.7998e-01            FAILED                
13   1.9455e+01            FAILED                
14   7.8570e+00            FAILED                
15   3.0717e+00            FAILED                
16   9.8209e+02            FAILED                
17   2.3703e+04            FAILED                
18   3.7206e+01            FAILED                
19   8.3515e+01            FAILED                
20   2.0536e+01            FAILED                
21   5.7170e+00            FAILED                
22   1.2056e+01            FAILED                
23   5.7883e+01            FAILED                

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 2.370e+04  (target = 1e-08)
  Task  5: best error so far = 2.983e+03  (target = 1e-08)
  ...
  Task 19: best error so far = 8.351e+01  (target = 1e-08)
  Task 23: best error so far = 5.788e+01  (target = 1e-08)
  Task  9: best error so far = 5.025e+01  (target = 1e-08)
