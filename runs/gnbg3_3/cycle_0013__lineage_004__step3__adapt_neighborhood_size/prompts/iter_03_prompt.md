This is iteration 3 of 10. Propose ONE replacement implementation for `_adapt_neighborhood_size`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 17: *** UNSOLVED *** — best=3.975e+04 by variant_02_catB_idea_0.py (target=1e-08, ~+12.6 decades above target)
  ...
  Task 11: *** UNSOLVED *** — best=1.763e+02 by variant_02_catB_idea_0.py (target=1e-08, ~+10.2 decades above target)
  ...
  Task 18: *** UNSOLVED *** — best=3.916e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.6 decades above target)
  ...
  Task 22: *** UNSOLVED *** — best=1.232e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.1 decades above target)
  ...
  Task 15: *** UNSOLVED *** — best=3.376e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.5 decades above target)
  Task  8: *** UNSOLVED *** — best=2.682e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.4 decades above target)
  ...
  Task 12: *** UNSOLVED *** — best=1.000e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.0 decades above target)
...
-----------------------------------------------------------------------
0    1.6316e-01            -inf                  1.3284e-01            
1    2.7012e+00            -inf                  1.8783e+00            
2    4.2523e-01            -inf                  1.8318e-01            
3    6.7802e+00            -inf                  5.4416e+00            
4    1.1887e+00            -inf                  1.1654e+00            
5    2.6338e+01            -inf                  6.3907e+02            
6    6.8615e+02            -inf                  3.6765e+02            
7    1.0714e+01            -inf                  5.9825e+00            
8    2.9501e+00            -inf                  2.6823e+00            
9    1.0488e+02            -inf                  2.5650e+01            
10   1.4162e+01            -inf                  2.4329e-01            
11   1.9660e+02            -inf                  1.7627e+02            
12   7.2507e+01            -inf                  1.0002e+00            
13   1.6845e+01            -inf                  2.4396e+01            
14   8.8464e+00            -inf                  4.3140e+00            
15   3.6800e+00            -inf                  3.3764e+00            
16   2.1229e+03            -inf                  2.1985e+03            
17   5.0208e+04            -inf                  3.9750e+04            
18   5.1198e+01            -inf                  3.9160e+01            
19   1.4016e+02            -inf                  7.6548e+01            
20   2.5500e+01            -inf                  2.0853e+01            
21   5.4742e+00            -inf                  5.8144e+00            
22   1.3764e+01            -inf                  1.2319e+01            
23   6.5064e+01            -inf                  4.4520e+01            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 3.975e+04  (target = 1e-08)
  Task 16: best error so far = 2.123e+03  (target = 1e-08)
  Task  6: best error so far = 3.676e+02  (target = 1e-08)
  Task 11: best error so far = 1.763e+02  (target = 1e-08)
  Task 19: best error so far = 7.655e+01  (target = 1e-08)
  Task 23: best error so far = 4.452e+01  (target = 1e-08)
  Task 18: best error so far = 3.916e+01  (target = 1e-08)
