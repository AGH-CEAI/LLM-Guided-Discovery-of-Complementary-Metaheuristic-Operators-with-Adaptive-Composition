...
CANDIDATE methods with metadata (you MUST pick exactly 3 distinct names):
  ...
  _position_update_fitness_rank                hot_path     37   MODIFIES_distribution  in_main_loop  called_by=[_dispatch_position_update]
  _compute_fingerprint                         leaf         62   in_main_loop  called_by=[__call__]
  _position_update_temporal_drift              hot_path     70   MODIFIES_distribution  in_main_loop  called_by=[_dispatch_position_update]
