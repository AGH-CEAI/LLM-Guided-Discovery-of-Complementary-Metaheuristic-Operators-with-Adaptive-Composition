...
- AdaptiveStrategyPoolDE
- CovarianceEnhancedParticleSwarm
- QuantumParticleSwarmOptimizer
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 2.603548e+01
  from lineage 1, cycle 4

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=1.765e-01
  Task  1: error=2.192e+00  *** NEEDS IMPROVEMENT ***
  Task  2: error=3.869e-01
  Task  3: error=6.292e+00  *** NEEDS IMPROVEMENT ***
  Task  4: error=1.200e+00  *** NEEDS IMPROVEMENT ***
  Task  5: error=5.782e+01  *** NEEDS IMPROVEMENT ***
  Task  6: error=8.065e+02  *** NEEDS IMPROVEMENT ***
  Task  7: error=8.760e+00  *** NEEDS IMPROVEMENT ***
  Task  8: error=3.070e+00  *** NEEDS IMPROVEMENT ***
  Task  9: error=1.158e+02  *** NEEDS IMPROVEMENT ***
  Task 10: error=2.701e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=2.529e+02  *** NEEDS IMPROVEMENT ***
  Task 12: error=6.220e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=2.181e+01  *** NEEDS IMPROVEMENT ***
  Task 14: error=1.109e+01  *** NEEDS IMPROVEMENT ***
  Task 15: error=3.400e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=2.488e+03  *** NEEDS IMPROVEMENT ***
  Task 17: error=5.100e+04  *** NEEDS IMPROVEMENT ***
  Task 18: error=4.878e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.831e+02  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.668e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=5.439e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=1.416e+01  *** NEEDS IMPROVEMENT ***
  Task 23: error=7.046e+01  *** NEEDS IMPROVEMENT ***

History stats: 5 cycles, 5 improvements, 0 crashes
