This is iteration 7 of 10. Propose ONE replacement implementation for `_position_update_fitness_rank`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task  6: *** UNSOLVED *** — best=5.372e+02 by original.py               (target=1e-08, ~+10.7 decades above target)
  Task  5: *** UNSOLVED *** — best=3.911e+02 by original.py               (target=1e-08, ~+10.6 decades above target)
  Task 11: *** UNSOLVED *** — best=8.285e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.9 decades above target)
  Task 19: *** UNSOLVED *** — best=7.132e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.9 decades above target)
  Task 23: *** UNSOLVED *** — best=5.815e+01 by variant_02_catB_idea_0.py (target=1e-08, ~+9.8 decades above target)
  ...
  Task 20: *** UNSOLVED *** — best=2.039e+01 by variant_04_catD_idea_0.py (target=1e-08, ~+9.3 decades above target)
  Task 13: *** UNSOLVED *** — best=1.780e+01 by variant_04_catD_idea_0.py (target=1e-08, ~+9.3 decades above target)
  ...
  Task 15: *** UNSOLVED *** — best=3.180e+00 by variant_04_catD_idea_0.py (target=1e-08, ~+8.5 decades above target)
  ...
  Task  4: *** UNSOLVED *** — best=1.271e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.1 decades above target)
  Task 12: *** UNSOLVED *** — best=4.561e-01 by original.py               (target=1e-08, ~+7.7 decades above target)
  Task 10: *** UNSOLVED *** — best=2.485e-01 by original.py               (target=1e-08, ~+7.4 decades above target)
  Task  2: *** UNSOLVED *** — best=1.950e-01 by variant_04_catD_idea_0.py (target=1e-08, ~+7.3 decades above target)
  Task  0: *** UNSOLVED *** — best=1.353e-01 by variant_02_catB_idea_0.py (target=1e-08, ~+7.1 decades above target)
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.4065e-01            FAILED                1.3535e-01            -inf                  1.4135e-01            -inf                  -inf                  
1    1.8864e+00            FAILED                2.8835e+00            -inf                  1.5204e+00            -inf                  -inf                  
2    2.0692e-01            FAILED                2.0668e-01            -inf                  1.9504e-01            -inf                  -inf                  
3    5.5085e+00            FAILED                5.7897e+00            -inf                  5.4841e+00            -inf                  -inf                  
4    1.2922e+00            FAILED                1.2711e+00            -inf                  1.2943e+00            -inf                  -inf                  
5    3.9113e+02            FAILED                2.3110e+03            -inf                  1.5960e+03            -inf                  -inf                  
6    5.3717e+02            FAILED                5.6492e+02            -inf                  5.5800e+02            -inf                  -inf                  
7    6.6987e+00            FAILED                6.0879e+00            -inf                  6.2446e+00            -inf                  -inf                  
8    2.5605e+00            FAILED                2.7069e+00            -inf                  2.8356e+00            -inf                  -inf                  
9    4.2032e+01            FAILED                5.1060e+01            -inf                  3.4171e+01            -inf                  -inf                  
10   2.4854e-01            FAILED                2.5050e-01            -inf                  2.7545e-01            -inf                  -inf                  
11   8.5819e+01            FAILED                8.2854e+01            -inf                  9.7063e+01            -inf                  -inf                  
12   4.5610e-01            FAILED                1.1224e+00            -inf                  6.3501e-01            -inf                  -inf                  
13   1.8498e+01            FAILED                2.0558e+01            -inf                  1.7802e+01            -inf                  -inf                  
14   8.6557e+00            FAILED                8.1433e+00            -inf                  7.5748e+00            -inf                  -inf                  
15   3.2001e+00            FAILED                3.2486e+00            -inf                  3.1798e+00            -inf                  -inf                  
16   7.7211e+02            FAILED                7.8157e+02            -inf                  1.2568e+03            -inf                  -inf                  
17   1.8470e+04            FAILED                2.3996e+04            -inf                  2.3181e+04            -inf                  -inf                  
18   3.4928e+01            FAILED                4.3072e+01            -inf                  3.3518e+01            -inf                  -inf                  
19   9.0761e+01            FAILED                7.1318e+01            -inf                  8.0410e+01            -inf                  -inf                  
20   2.0538e+01            FAILED                2.1239e+01            -inf                  2.0387e+01            -inf                  -inf                  
21   5.4051e+00            FAILED                5.6854e+00            -inf                  5.5257e+00            -inf                  -inf                  
22   1.1260e+01            FAILED                1.0537e+01            -inf                  1.1147e+01            -inf                  -inf                  
23   5.9545e+01            FAILED                5.8154e+01            -inf                  5.8964e+01            -inf                  -inf                  
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  ...
  Task  6: best error so far = 5.372e+02  (target = 1e-08)
  Task  5: best error so far = 3.911e+02  (target = 1e-08)
  Task 11: best error so far = 8.285e+01  (target = 1e-08)
  Task 19: best error so far = 7.132e+01  (target = 1e-08)
  Task 23: best error so far = 5.815e+01  (target = 1e-08)
