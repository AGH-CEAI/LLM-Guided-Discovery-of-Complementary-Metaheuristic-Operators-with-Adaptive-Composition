...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 17: *** UNSOLVED *** — best=5.006e+04 by variant_02_catB_idea_0.py (target=1e-08, ~+12.7 decades above target)
  Task 16: *** UNSOLVED *** — best=1.703e+03 by variant_04_catD_idea_0.py (target=1e-08, ~+11.2 decades above target)
  ...
  Task  3: *** UNSOLVED *** — best=6.387e+00 by variant_02_catB_idea_0.py (target=1e-08, ~+8.8 decades above target)
  ...
  Task  1: *** UNSOLVED *** — best=2.671e+00 by variant_04_catD_idea_0.py (target=1e-08, ~+8.4 decades above target)
  Task  4: *** UNSOLVED *** — best=1.242e+00 by variant_04_catD_idea_0.py (target=1e-08, ~+8.1 decades above target)
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.5051e-01            FAILED                1.7144e-01            -inf                  1.7422e-01            -inf                  -inf                  
1    3.5369e+00            FAILED                2.7637e+00            -inf                  2.6713e+00            -inf                  -inf                  
2    4.3335e-01            FAILED                3.8456e-01            -inf                  3.5999e-01            -inf                  -inf                  
3    6.5420e+00            FAILED                6.3872e+00            -inf                  6.6254e+00            -inf                  -inf                  
4    1.2476e+00            FAILED                1.2558e+00            -inf                  1.2420e+00            -inf                  -inf                  
5    4.4042e+01            FAILED                5.0149e+01            -inf                  6.1512e+01            -inf                  -inf                  
6    6.9928e+02            FAILED                7.2492e+02            -inf                  7.5915e+02            -inf                  -inf                  
7    1.0881e+01            FAILED                9.9057e+00            -inf                  1.0111e+01            -inf                  -inf                  
8    2.8281e+00            FAILED                2.9664e+00            -inf                  2.8722e+00            -inf                  -inf                  
9    1.0780e+02            FAILED                1.1418e+02            -inf                  1.0463e+02            -inf                  -inf                  
10   1.7880e+01            FAILED                2.0344e+01            -inf                  1.7442e+01            -inf                  -inf                  
11   1.6511e+02            FAILED                2.0499e+02            -inf                  1.8593e+02            -inf                  -inf                  
12   6.5107e+01            FAILED                7.3679e+01            -inf                  5.0329e+01            -inf                  -inf                  
13   1.3990e+01            FAILED                1.5272e+01            -inf                  1.2632e+01            -inf                  -inf                  
14   8.6070e+00            FAILED                8.7743e+00            -inf                  9.7651e+00            -inf                  -inf                  
15   3.5220e+00            FAILED                3.6440e+00            -inf                  3.5916e+00            -inf                  -inf                  
16   1.7571e+03            FAILED                2.0175e+03            -inf                  1.7032e+03            -inf                  -inf                  
17   5.0548e+04            FAILED                5.0056e+04            -inf                  6.3511e+04            -inf                  -inf                  
18   4.5894e+01            FAILED                4.3270e+01            -inf                  4.5948e+01            -inf                  -inf                  
19   1.2227e+02            FAILED                1.4153e+02            -inf                  1.2342e+02            -inf                  -inf                  
20   2.6350e+01            FAILED                2.5870e+01            -inf                  2.5474e+01            -inf                  -inf                  
21   5.7044e+00            FAILED                5.6430e+00            -inf                  5.5116e+00            -inf                  -inf                  
22   1.3055e+01            FAILED                1.3952e+01            -inf                  1.4035e+01            -inf                  -inf                  
23   7.0593e+01            FAILED                6.9591e+01            -inf                  7.0067e+01            -inf                  -inf                  

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 5.006e+04  (target = 1e-08)
  Task 16: best error so far = 1.703e+03  (target = 1e-08)
