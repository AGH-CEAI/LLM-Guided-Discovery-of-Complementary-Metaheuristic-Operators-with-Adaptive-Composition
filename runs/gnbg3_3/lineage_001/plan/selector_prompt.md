...
CANDIDATE methods with metadata (you MUST pick exactly 3 distinct names):
  ...
  -------------------------------------------- ------------ ---- -----------------------------------
  _clip_to_bounds                              observer     3    in_main_loop  PURE_observer  called_by=[_evaluate_batch, _position_update_batch, _restart_if_stagnant]
  _update_personal_best_batch                  leaf         5    in_main_loop  called_by=[__call__]
  _compute_diversity                           observer     5    in_main_loop  PURE_observer  called_by=[_adapt_neighborhood_size]
  ...
  _evaluate_batch                              observer     10   in_main_loop  PURE_observer  called_by=[__call__]
  _compute_global_best                         leaf         10   in_main_loop  called_by=[__call__]
  _adapt_neighborhood_size                     leaf         10   in_main_loop  called_by=[__call__]
  _adaptive_coefficients                       observer     10   in_main_loop  PURE_observer  called_by=[_velocity_update_original, _velocity_update_variant_03_catC, _velocity_update_variant_05_catE, +1 more]
  _select_best_operator                        observer     12   in_main_loop  PURE_observer  called_by=[__call__]
  _compute_ucb_score                           observer     16   in_main_loop  PURE_observer  called_by=[_select_best_operator, _select_runner_up_operator]
  _dispatch_velocity_update                    leaf         17   in_main_loop  called_by=[__call__]
  _initialize_population                       hot_path     18   MODIFIES_distribution  called_by=[__call__]
  _compute_local_best_batch                    control_flow 21   in_main_loop  called_by=[__call__]
  _position_update_batch                       hot_path     22   MODIFIES_distribution  in_main_loop  called_by=[__call__]
  _restart_if_stagnant                         leaf         25   in_main_loop  called_by=[__call__]
  _record_probe_score                          leaf         26   in_main_loop  called_by=[__call__]
  _adapt_inertia_weight                        leaf         27   in_main_loop  called_by=[__call__]
  _velocity_update_original                    control_flow 37   in_main_loop  called_by=[_dispatch_velocity_update]
  _velocity_update_variant_01_catA             control_flow 50   in_main_loop  called_by=[_dispatch_velocity_update]
  _velocity_update_variant_04_catD             control_flow 53   in_main_loop  called_by=[_dispatch_velocity_update]
  _velocity_update_variant_03_catC             leaf         62   in_main_loop  called_by=[_dispatch_velocity_update]
  _velocity_update_variant_10_catB             control_flow 80   in_main_loop  called_by=[_dispatch_velocity_update]
  _velocity_update_variant_05_catE             control_flow 113  in_main_loop  called_by=[_dispatch_velocity_update]
