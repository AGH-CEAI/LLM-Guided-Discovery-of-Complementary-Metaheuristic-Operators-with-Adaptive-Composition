...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 17: *** UNSOLVED *** — best=4.778e+04 by variant_05_catE_idea_0.py (target=1e-08, ~+12.7 decades above target)
  Task 16: *** UNSOLVED *** — best=2.536e+03 by variant_05_catE_idea_0.py (target=1e-08, ~+11.4 decades above target)
  Task  6: *** UNSOLVED *** — best=7.318e+02 by variant_05_catE_idea_0.py (target=1e-08, ~+10.9 decades above target)
  Task 11: *** UNSOLVED *** — best=2.076e+02 by variant_08_catH_idea_0.py (target=1e-08, ~+10.3 decades above target)
  Task 19: *** UNSOLVED *** — best=1.733e+02 by variant_05_catE_idea_0.py (target=1e-08, ~+10.2 decades above target)
  Task  9: *** UNSOLVED *** — best=1.131e+02 by variant_05_catE_idea_0.py (target=1e-08, ~+10.1 decades above target)
  Task 23: *** UNSOLVED *** — best=7.150e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.9 decades above target)
  Task 12: *** UNSOLVED *** — best=6.075e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.8 decades above target)
  Task 18: *** UNSOLVED *** — best=4.803e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.7 decades above target)
  Task 10: *** UNSOLVED *** — best=2.517e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.4 decades above target)
  Task 20: *** UNSOLVED *** — best=2.516e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.4 decades above target)
  Task 13: *** UNSOLVED *** — best=1.842e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.3 decades above target)
  Task 22: *** UNSOLVED *** — best=1.357e+01 by variant_05_catE_idea_0.py (target=1e-08, ~+9.1 decades above target)
  Task 14: *** UNSOLVED *** — best=9.954e+00 by variant_08_catH_idea_0.py (target=1e-08, ~+9.0 decades above target)
  Task  5: *** UNSOLVED *** — best=9.701e+00 by variant_05_catE_idea_0.py (target=1e-08, ~+9.0 decades above target)
  Task  7: *** UNSOLVED *** — best=8.228e+00 by original.py               (target=1e-08, ~+8.9 decades above target)
  Task  3: *** UNSOLVED *** — best=6.293e+00 by variant_08_catH_idea_0.py (target=1e-08, ~+8.8 decades above target)
  ...
  Task  8: *** UNSOLVED *** — best=2.897e+00 by variant_05_catE_idea_0.py (target=1e-08, ~+8.5 decades above target)
  Task  1: *** UNSOLVED *** — best=1.683e+00 by original.py               (target=1e-08, ~+8.2 decades above target)
  Task  4: *** UNSOLVED *** — best=1.165e+00 by variant_05_catE_idea_0.py (target=1e-08, ~+8.1 decades above target)
  Task  2: *** UNSOLVED *** — best=3.343e-01 by variant_08_catH_idea_0.py (target=1e-08, ~+7.5 decades above target)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.8408e-01            -inf                  1.6329e-01            -inf                  -inf                  1.7470e-01            -inf                  -inf                  1.8733e-01            
1    1.6832e+00            -inf                  2.2722e+00            -inf                  -inf                  3.5180e+00            -inf                  -inf                  3.0609e+00            
2    3.5543e-01            -inf                  3.4826e-01            -inf                  -inf                  4.1168e-01            -inf                  -inf                  3.3431e-01            
3    6.3881e+00            -inf                  6.4001e+00            -inf                  -inf                  6.4395e+00            -inf                  -inf                  6.2930e+00            
4    1.1843e+00            -inf                  1.2462e+00            -inf                  -inf                  1.1645e+00            -inf                  -inf                  1.3073e+00            
5    7.9770e+01            -inf                  3.0108e+01            -inf                  -inf                  9.7014e+00            -inf                  -inf                  2.6717e+01            
6    7.5481e+02            -inf                  7.8640e+02            -inf                  -inf                  7.3183e+02            -inf                  -inf                  7.8162e+02            
7    8.2283e+00            -inf                  9.1365e+00            -inf                  -inf                  1.1730e+01            -inf                  -inf                  8.8195e+00            
8    3.1087e+00            -inf                  2.9680e+00            -inf                  -inf                  2.8970e+00            -inf                  -inf                  2.9703e+00            
9    1.1952e+02            -inf                  1.1668e+02            -inf                  -inf                  1.1310e+02            -inf                  -inf                  1.1655e+02            
10   2.6517e+01            -inf                  2.8795e+01            -inf                  -inf                  2.5631e+01            -inf                  -inf                  2.5169e+01            
11   2.0857e+02            -inf                  2.2336e+02            -inf                  -inf                  2.3278e+02            -inf                  -inf                  2.0763e+02            
12   6.8654e+01            -inf                  7.3616e+01            -inf                  -inf                  6.7502e+01            -inf                  -inf                  6.0750e+01            
13   2.2073e+01            -inf                  2.0001e+01            -inf                  -inf                  2.2671e+01            -inf                  -inf                  1.8415e+01            
14   1.0902e+01            -inf                  1.0760e+01            -inf                  -inf                  1.0822e+01            -inf                  -inf                  9.9544e+00            
15   3.5397e+00            -inf                  3.7487e+00            -inf                  -inf                  3.6268e+00            -inf                  -inf                  3.6591e+00            
16   2.6115e+03            -inf                  2.9847e+03            -inf                  -inf                  2.5362e+03            -inf                  -inf                  2.7342e+03            
17   5.7701e+04            -inf                  5.5872e+04            -inf                  -inf                  4.7778e+04            -inf                  -inf                  6.2958e+04            
18   5.0650e+01            -inf                  5.0135e+01            -inf                  -inf                  4.8762e+01            -inf                  -inf                  4.8035e+01            
19   1.8732e+02            -inf                  1.8532e+02            -inf                  -inf                  1.7334e+02            -inf                  -inf                  1.7740e+02            
20   2.7383e+01            -inf                  2.7028e+01            -inf                  -inf                  2.7313e+01            -inf                  -inf                  2.5158e+01            
21   5.4444e+00            -inf                  5.7008e+00            -inf                  -inf                  5.6185e+00            -inf                  -inf                  5.5120e+00            
22   1.4380e+01            -inf                  1.4449e+01            -inf                  -inf                  1.3568e+01            -inf                  -inf                  1.4112e+01            
23   7.1963e+01            -inf                  7.3873e+01            -inf                  -inf                  7.2533e+01            -inf                  -inf                  7.1499e+01            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 4.778e+04  (target = 1e-08)
  Task 16: best error so far = 2.536e+03  (target = 1e-08)
  Task  6: best error so far = 7.318e+02  (target = 1e-08)
  Task 11: best error so far = 2.076e+02  (target = 1e-08)
  Task 19: best error so far = 1.733e+02  (target = 1e-08)
  Task  9: best error so far = 1.131e+02  (target = 1e-08)
  Task 23: best error so far = 7.150e+01  (target = 1e-08)
  Task 12: best error so far = 6.075e+01  (target = 1e-08)
