...
CANDIDATE methods (you MUST pick exactly 3 distinct names from this list):
  ...
  - _initialize_population  (12 LOC)
  - _adapt_F_CR_jade_style  (27 LOC)
...
HISTORY of cycles in this lineage so far (most recent last):
  ...
  Methods already made adaptive (excluded from candidates): _adapt_strategy_probabilities
