This is iteration 2 of 10. Propose ONE replacement implementation for `_adapt_strategy_probabilities`.
...
TASK COVERAGE SUMMARY: 12 covered, 10 UNCOVERED, 2 trivial (out of 24)
Goal: get at least one winning variant for every non-trivial task.

  Task  0: TRIVIAL (already at optimum, error=1.00e-08)
  Task  1: COVERED — best=variant_01_idea_0.py       error=2.490e+00 (orig=3.318e+00, -25%)
  Task  2: TRIVIAL (already at optimum, error=1.00e-08)
  Task  3: *** UNCOVERED *** — orig error=1.829e+00, no variant improves on this
  Task  4: COVERED — best=variant_01_idea_0.py       error=4.651e-02 (orig=8.728e-02, -47%)
  Task  5: *** UNCOVERED *** — orig error=3.740e+01, no variant improves on this
  Task  6: COVERED — best=variant_01_idea_0.py       error=1.549e+02 (orig=1.655e+02, -6%)
  Task  7: COVERED — best=variant_01_idea_0.py       error=2.865e+00 (orig=3.674e+00, -22%)
  Task  8: COVERED — best=variant_01_idea_0.py       error=1.621e+00 (orig=2.049e+00, -21%)
  Task  9: COVERED — best=variant_01_idea_0.py       error=3.045e+01 (orig=4.063e+01, -25%)
  Task 10: *** UNCOVERED *** — orig error=3.917e-04, no variant improves on this
  Task 11: COVERED — best=variant_01_idea_0.py       error=1.006e+02 (orig=1.030e+02, -2%)
  Task 12: *** UNCOVERED *** — orig error=7.319e-05, no variant improves on this
  Task 13: *** UNCOVERED *** — orig error=8.830e+00, no variant improves on this
  Task 14: COVERED — best=variant_01_idea_0.py       error=6.290e+00 (orig=8.034e+00, -22%)
  Task 15: *** UNCOVERED *** — orig error=2.550e+00, no variant improves on this
  Task 16: *** UNCOVERED *** — orig error=8.035e+02, no variant improves on this
  Task 17: *** UNCOVERED *** — orig error=1.258e+04, no variant improves on this
  Task 18: *** UNCOVERED *** — orig error=2.799e+01, no variant improves on this
  Task 19: COVERED — best=variant_01_idea_0.py       error=5.893e+01 (orig=1.215e+02, -51%)
  Task 20: *** UNCOVERED *** — orig error=1.622e+01, no variant improves on this
  Task 21: COVERED — best=variant_01_idea_0.py       error=4.738e+00 (orig=4.963e+00, -5%)
  Task 22: COVERED — best=variant_01_idea_0.py       error=7.362e+00 (orig=9.457e+00, -22%)
  Task 23: COVERED — best=variant_01_idea_0.py       error=4.951e+01 (orig=5.676e+01, -13%)

PER-TASK BENCHMARK ERRORS (raw numbers, lower is better):
Task original.py           variant_01_idea_0.py  
-------------------------------------------------
0    1.0000e-08            1.0000e-08            
1    3.3177e+00            2.4898e+00            
2    1.0000e-08            1.9957e-08            
3    1.8295e+00            2.0945e+00            
4    8.7280e-02            4.6511e-02            
5    3.7404e+01            8.2055e+01            
6    1.6552e+02            1.5491e+02            
7    3.6743e+00            2.8654e+00            
8    2.0487e+00            1.6211e+00            
9    4.0626e+01            3.0446e+01            
10   3.9173e-04            1.0882e+00            
11   1.0300e+02            1.0059e+02            
12   7.3192e-05            3.2372e+00            
13   8.8299e+00            2.0797e+01            
14   8.0335e+00            6.2898e+00            
15   2.5496e+00            2.7994e+00            
16   8.0353e+02            1.0584e+03            
17   1.2580e+04            1.8762e+04            
18   2.7990e+01            3.5975e+01            
19   1.2145e+02            5.8934e+01            
20   1.6216e+01            1.8952e+01            
21   4.9630e+00            4.7378e+00            
22   9.4574e+00            7.3623e+00            
23   5.6761e+01            4.9511e+01            

TASKS WHERE NO VARIANT CURRENTLY BEATS THE ORIGINAL (priority targets):
3, 5, 6, 10, 11, 12, 13, 15, 16, 17, 18, 20, 21
