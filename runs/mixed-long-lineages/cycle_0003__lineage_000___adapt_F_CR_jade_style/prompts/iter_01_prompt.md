This is iteration 1 of 10. Propose ONE replacement implementation for `_adapt_F_CR_jade_style`.

Requirements:
- Keep the EXACT function signature: `def _adapt_F_CR_jade_style(self, population, fitness, trials, trial_fitness, improved_mask):`
...
```python
def _adapt_F_CR_jade_style(self, ...):
    ...
```