...
CANDIDATE methods (you MUST pick exactly 3 distinct names from this list):
  - _compute_diversity  (4 LOC)
  - _evaluate_batch  (5 LOC)
  - _select_three_distinct  (5 LOC)
  - _select_five_distinct  (5 LOC)
  - _select_crossover_operator  (7 LOC)
  - _clip_reflective  (8 LOC)
  - _mutate_batch  (9 LOC)
  - _select_survivors_batch  (9 LOC)
  - _update_strategy_success  (9 LOC)
  - _check_stagnation  (9 LOC)
  - _reinitialize_stagnant_subpopulation  (9 LOC)
  - _crossover_original  (11 LOC)
  - _initialize_population  (18 LOC)
  - _crossover_dim_adaptive  (25 LOC)
  - _adapt_F_CR_jade_style  (25 LOC)
  - _crossover_diversity_blend  (28 LOC)
  - _update_crossover_reward  (28 LOC)
  - _crossover_hybrid_binexp  (29 LOC)
  - _mutate_single_reflective  (33 LOC)

HISTORY of cycles in this lineage so far (most recent last):
  ✔ cycle   0: targeted=_adapt_strategy_probabilities best_gm=6.142e-01  (new geomean 6.142e-01 < incumbent 1.200e+00)
  ✔ cycle   1: targeted=_crossover_batch             best_gm=2.258e-01  (new geomean 2.258e-01 < incumbent 6.826e-01)
  ✗ cycle   2: targeted=_crossover_block             best_gm=2.263e-01  (new geomean 2.263e-01 >= incumbent 2.263e-01)

  Methods already made adaptive (excluded from candidates): _adapt_strategy_probabilities, _crossover_batch
