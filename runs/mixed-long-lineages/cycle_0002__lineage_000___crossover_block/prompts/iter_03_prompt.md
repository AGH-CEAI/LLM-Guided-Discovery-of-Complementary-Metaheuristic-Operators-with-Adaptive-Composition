This is iteration 3 of 10. Propose ONE replacement implementation for `_crossover_block`.
...
Goal: get at least one winning variant for every non-trivial task.
  ...
  Task  6: *** UNCOVERED *** — orig error=3.663e+01, no variant improves on this
  ...
  Task 11: COVERED — best=variant_01_idea_0.py       error=8.285e+01 (orig=8.567e+01, -3%)
  Task 12: TRIVIAL (already at optimum, error=1.82e-08)
  Task 13: *** UNCOVERED *** — orig error=1.278e+01, no variant improves on this
  Task 14: COVERED — best=variant_01_idea_0.py       error=6.855e+00 (orig=6.927e+00, -1%)
  Task 15: *** UNCOVERED *** — orig error=2.768e+00, no variant improves on this
  Task 16: *** UNCOVERED *** — orig error=8.035e+02, no variant improves on this
  Task 17: COVERED — best=variant_01_idea_0.py       error=6.521e+03 (orig=1.046e+04, -38%)
  Task 18: *** UNCOVERED *** — orig error=2.647e+01, no variant improves on this
  Task 19: COVERED — best=variant_01_idea_0.py       error=8.040e+01 (orig=8.725e+01, -8%)
  Task 20: *** UNCOVERED *** — orig error=1.633e+01, no variant improves on this
  Task 21: *** UNCOVERED *** — orig error=4.884e+00, no variant improves on this
  Task 22: *** UNCOVERED *** — orig error=1.002e+01, no variant improves on this
  Task 23: COVERED — best=variant_01_idea_0.py       error=4.142e+01 (orig=4.183e+01, -1%)
...
1    1.2220e+00            3.4117e+00            -inf                  
2    1.0000e-08            1.0000e-08            -inf                  
3    1.5010e+00            2.8815e+00            -inf                  
4    1.0000e-08            5.1805e-02            -inf                  
5    1.4439e+01            1.7878e+02            -inf                  
6    3.6629e+01            4.0501e+01            -inf                  
7    3.8524e+00            5.9440e+00            -inf                  
8    1.6350e+00            1.6812e+00            -inf                  
9    2.1498e+01            1.3563e+01            -inf                  
10   1.0000e-08            1.0000e-08            -inf                  
11   8.5667e+01            8.2849e+01            -inf                  
12   1.8164e-08            5.0815e-06            -inf                  
13   1.2779e+01            2.3181e+01            -inf                  
14   6.9274e+00            6.8553e+00            -inf                  
15   2.7678e+00            3.8032e+00            -inf                  
16   8.0353e+02            1.0717e+03            -inf                  
17   1.0458e+04            6.5205e+03            -inf                  
18   2.6469e+01            3.1235e+01            -inf                  
19   8.7248e+01            8.0404e+01            -inf                  
20   1.6331e+01            1.9223e+01            -inf                  
21   4.8840e+00            4.8955e+00            -inf                  
22   1.0019e+01            1.1237e+01            -inf                  
23   4.1830e+01            4.1422e+01            -inf                  

TASKS WHERE NO VARIANT CURRENTLY BEATS THE ORIGINAL (priority targets):
1, 3, 5, 6, 7, 8, 11, 13, 14, 15, 16, 18, 19, 20, 21, 22, 23
