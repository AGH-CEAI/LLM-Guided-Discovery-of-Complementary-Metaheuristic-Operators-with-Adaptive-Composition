...
Requirements:
- Keep the EXACT function signature: `def _check_stagnation(self, fitness):`
...
TASK COVERAGE SUMMARY: 15 covered, 4 UNCOVERED, 5 trivial (out of 24)
Goal: get at least one winning variant for every non-trivial task.

  Task  0: TRIVIAL (already at optimum, error=1.00e-08)
  Task  1: COVERED — best=variant_06_idea_0.py       error=8.227e-01 (orig=1.843e+00, -55%)
  Task  2: TRIVIAL (already at optimum, error=1.00e-08)
  Task  3: COVERED — best=variant_05_idea_0.py       error=1.194e+00 (orig=1.963e+00, -39%)
  Task  4: TRIVIAL (already at optimum, error=1.00e-08)
  Task  5: COVERED — best=variant_06_idea_0.py       error=5.294e+00 (orig=3.646e+01, -85%)
  Task  6: COVERED — best=variant_05_idea_0.py       error=3.208e+01 (orig=3.595e+01, -11%)
  Task  7: COVERED — best=variant_01_idea_0.py       error=3.373e+00 (orig=4.274e+00, -21%)
  Task  8: COVERED — best=variant_01_idea_0.py       error=1.302e+00 (orig=1.332e+00, -2%)
  Task  9: COVERED — best=variant_02_idea_0.py       error=1.383e+01 (orig=1.400e+01, -1%)
  Task 10: TRIVIAL (already at optimum, error=1.00e-08)
  Task 11: COVERED — best=variant_05_idea_0.py       error=2.180e+01 (orig=3.938e+01, -45%)
  Task 12: TRIVIAL (already at optimum, error=1.65e-08)
  Task 13: COVERED — best=variant_02_idea_0.py       error=5.846e+00 (orig=1.416e+01, -59%)
  Task 14: *** UNCOVERED *** — orig error=6.663e+00, no variant improves on this
  Task 15: *** UNCOVERED *** — orig error=2.390e+00, no variant improves on this
  Task 16: *** UNCOVERED *** — orig error=6.693e+02, no variant improves on this
  Task 17: *** UNCOVERED *** — orig error=2.532e+03, no variant improves on this
  Task 18: COVERED — best=variant_05_idea_0.py       error=2.541e+01 (orig=2.670e+01, -5%)
  Task 19: COVERED — best=variant_06_idea_0.py       error=7.552e+01 (orig=8.923e+01, -15%)
  Task 20: COVERED — best=variant_01_idea_0.py       error=1.708e+01 (orig=1.799e+01, -5%)
  Task 21: COVERED — best=variant_06_idea_0.py       error=4.821e+00 (orig=4.850e+00, -1%)
  Task 22: COVERED — best=variant_04_idea_0.py       error=8.388e+00 (orig=9.849e+00, -15%)
  Task 23: COVERED — best=variant_04_idea_0.py       error=4.284e+01 (orig=4.350e+01, -2%)
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.0000e-08            1.0000e-08            1.0000e-08            -inf                  1.0000e-08            1.0000e-08            1.0000e-08            
1    1.8433e+00            1.4035e+00            1.3544e+00            -inf                  1.7979e+00            1.3129e+00            8.2270e-01            
