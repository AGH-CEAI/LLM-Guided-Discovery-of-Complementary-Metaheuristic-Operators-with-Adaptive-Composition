...
Best algorithm so far: geomean = 5.571958e-03
  from lineage 1, cycle 1

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: SOLVED  (error=8.76e-08)
  Task  1: error=2.371e-07
  Task  2: error=2.236e-05
  Task  3: error=3.472e-04
  Task  4: error=2.389e-02
  Task  5: SOLVED  (error=1.00e-08)
  Task  6: error=4.101e-07
  Task  7: error=1.342e-05
  Task  8: error=1.754e-03
  Task  9: error=4.805e-04
  Task 10: error=5.734e-03
  Task 11: error=2.101e+00  *** NEEDS IMPROVEMENT ***
  Task 12: error=7.497e-01
  Task 13: error=1.393e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.642e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=1.032e+00  *** NEEDS IMPROVEMENT ***
  Task 16: SOLVED  (error=4.00e-08)
  Task 17: error=3.120e+00  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.676e+00  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.233e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=4.491e+00  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.232e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=2.619e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=6.388e-01

History stats: 3 cycles, 1 improvements, 0 crashes
Methods that responded well to adaptation:
  - _sample_population_batch (1 successful adaptation(s))
