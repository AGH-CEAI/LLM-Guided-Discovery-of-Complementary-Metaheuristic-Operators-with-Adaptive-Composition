...
Best algorithm so far: geomean = 2.815178e-02
...
Per-task errors of the best algorithm (lower = better):
  ...
  Task  0: error=1.401e-07
  Task  1: error=2.949e-07
  Task  2: error=2.460e-05
  Task  3: error=4.128e-04
  Task  4: error=2.476e-02
  Task  5: SOLVED  (error=1.00e-08)
  Task  6: error=5.370e-07
  Task  7: error=1.747e-05
  Task  8: error=2.001e-03
  Task  9: error=5.789e-04
  Task 10: error=4.962e+00  *** NEEDS IMPROVEMENT ***
  Task 11: error=1.658e+00  *** NEEDS IMPROVEMENT ***
  Task 12: error=1.303e+00  *** NEEDS IMPROVEMENT ***
  Task 13: error=1.085e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=3.404e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=1.135e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=5.567e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=3.120e+00  *** NEEDS IMPROVEMENT ***
  Task 18: error=3.804e+00  *** NEEDS IMPROVEMENT ***
  Task 19: error=3.906e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.291e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.497e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=2.352e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=1.935e+01  *** NEEDS IMPROVEMENT ***

History stats: 3 cycles, 1 improvements, 0 crashes
Methods that responded well to adaptation:
  - _update_evolution_paths (1 successful adaptation(s))
