...
- AdaptiveTopologyDE
- CovarianceGuidedParticleSwarm
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.380377e+00
  from lineage 2, cycle 4

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=5.533e-02
  Task  1: error=3.987e-02
  Task  2: error=1.509e-01
  Task  3: error=1.355e-01
  Task  4: error=5.237e-01
  Task  5: error=1.640e-04
  Task  6: error=6.415e-02
  Task  7: error=1.301e-01
  Task  8: error=2.564e-01
  Task  9: error=1.012e-01
  Task 10: error=1.511e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=8.958e+00  *** NEEDS IMPROVEMENT ***
  Task 12: error=2.146e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=3.474e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.882e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=2.651e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=1.177e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=4.057e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.094e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=2.590e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=1.976e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.552e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=7.952e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=1.912e+01  *** NEEDS IMPROVEMENT ***

History stats: 6 cycles, 5 improvements, 0 crashes
