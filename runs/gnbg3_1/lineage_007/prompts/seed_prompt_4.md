...
- CovarianceGuidedDE
- CovarianceRankAdaptationOptimizer
- AdaptiveTopologyPSO
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.179945e+00
  from lineage 6, cycle 15

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=5.581e-02
  Task  1: error=4.225e-02
  Task  2: error=1.551e-01
  Task  3: error=1.732e-01
  Task  4: error=5.133e-01
  Task  5: error=1.329e-04
  Task  6: error=1.577e-02
  Task  7: error=8.062e-02
  Task  8: error=2.569e-01
  Task  9: error=9.360e-02
  Task 10: error=1.004e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=1.612e+01  *** NEEDS IMPROVEMENT ***
  Task 12: error=1.432e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=3.186e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.765e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=2.709e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=7.913e+01  *** NEEDS IMPROVEMENT ***
  Task 17: error=4.046e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=1.284e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.339e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=1.829e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.362e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=8.522e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=1.942e+01  *** NEEDS IMPROVEMENT ***

History stats: 18 cycles, 9 improvements, 0 crashes
