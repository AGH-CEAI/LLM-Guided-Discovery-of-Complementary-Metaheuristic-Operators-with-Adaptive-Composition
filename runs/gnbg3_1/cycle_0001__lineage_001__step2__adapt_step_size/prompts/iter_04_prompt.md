...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task 19: *** UNSOLVED *** — best=1.609e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  ...
  Task 14: *** UNSOLVED *** — best=2.684e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.4 decades above target)
  Task 15: *** UNSOLVED *** — best=2.671e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.4 decades above target)
  Task  3: *** UNSOLVED *** — best=6.176e-01 by variant_02_idea_0.py      (target=1e-08, ~+7.8 decades above target)
  ...
  Task  5: *** UNSOLVED *** — best=3.901e-04 by original.py               (target=1e-08, ~+4.6 decades above target)
...
---------------------------------------------------------------------------------------------
0    5.2954e-02            -inf                  6.0975e-02            -inf                  
1    4.4614e-02            -inf                  4.8228e-02            -inf                  
2    1.9373e-01            -inf                  3.6636e-01            -inf                  
3    7.9266e-01            -inf                  6.1757e-01            -inf                  
4    5.3165e-01            -inf                  5.5437e-01            -inf                  
5    3.9007e-04            -inf                  2.4715e-03            -inf                  
6    1.7607e+01            -inf                  9.4571e+00            -inf                  
7    1.3473e-01            -inf                  1.4815e-01            -inf                  
8    4.8637e-01            -inf                  1.3509e+00            -inf                  
9    3.8332e+00            -inf                  5.5813e+00            -inf                  
10   3.0195e+01            -inf                  2.2291e+01            -inf                  
11   4.0668e+01            -inf                  1.4436e+01            -inf                  
12   2.7167e+01            -inf                  1.7093e+01            -inf                  
13   4.8010e+00            -inf                  3.1095e+00            -inf                  
14   2.7788e+00            -inf                  2.6844e+00            -inf                  
15   2.7774e+00            -inf                  2.6713e+00            -inf                  
16   1.5634e+02            -inf                  1.1078e+02            -inf                  
17   1.0463e+03            -inf                  2.5118e+02            -inf                  
18   2.1989e+01            -inf                  2.0804e+01            -inf                  
19   1.6093e+01            -inf                  1.7759e+01            -inf                  
20   2.0516e+01            -inf                  2.2408e+01            -inf                  
21   4.5393e+00            -inf                  4.3962e+00            -inf                  
22   9.5190e+00            -inf                  8.4669e+00            -inf                  
23   1.4890e+01            -inf                  1.9349e+01            -inf                  
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  ...
  Task 19: best error so far = 1.609e+01  (target = 1e-08)
