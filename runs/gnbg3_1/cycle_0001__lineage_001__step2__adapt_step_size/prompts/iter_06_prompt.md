...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task 10: *** UNSOLVED *** — best=2.229e+01 by variant_02_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 18: *** UNSOLVED *** — best=2.080e+01 by variant_02_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 20: *** UNSOLVED *** — best=2.052e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  ...
  Task 19: *** UNSOLVED *** — best=1.472e+01 by variant_04_idea_0.py      (target=1e-08, ~+9.2 decades above target)
  ...
  Task 22: *** UNSOLVED *** — best=8.467e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.9 decades above target)
  ...
  Task 15: *** UNSOLVED *** — best=2.671e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.4 decades above target)
...
-----------------------------------------------------------------------------------------------------------------------------------------
0    5.2954e-02            -inf                  6.0975e-02            -inf                  5.4031e-02            7.7903e-02            
1    4.4614e-02            -inf                  4.8228e-02            -inf                  4.8759e-02            1.5416e-01            
2    1.9373e-01            -inf                  3.6636e-01            -inf                  7.9745e-01            4.5352e+00            
3    7.9266e-01            -inf                  6.1757e-01            -inf                  6.0485e-01            3.3676e+00            
4    5.3165e-01            -inf                  5.5437e-01            -inf                  5.5598e-01            9.9643e-01            
5    3.9007e-04            -inf                  2.4715e-03            -inf                  1.5087e-04            9.8340e+00            
6    1.7607e+01            -inf                  9.4571e+00            -inf                  1.2741e+01            2.5561e+01            
7    1.3473e-01            -inf                  1.4815e-01            -inf                  1.3649e-01            2.2232e+00            
8    4.8637e-01            -inf                  1.3509e+00            -inf                  5.4804e-01            2.3060e+00            
9    3.8332e+00            -inf                  5.5813e+00            -inf                  5.5498e+00            6.9928e+00            
10   3.0195e+01            -inf                  2.2291e+01            -inf                  2.9368e+01            2.3395e+01            
11   4.0668e+01            -inf                  1.4436e+01            -inf                  4.9307e+01            5.6651e+01            
12   2.7167e+01            -inf                  1.7093e+01            -inf                  3.0347e+01            4.1353e+01            
13   4.8010e+00            -inf                  3.1095e+00            -inf                  5.1575e+00            3.3386e+00            
14   2.7788e+00            -inf                  2.6844e+00            -inf                  2.6621e+00            2.8063e+00            
15   2.7774e+00            -inf                  2.6713e+00            -inf                  2.7845e+00            2.9807e+00            
16   1.5634e+02            -inf                  1.1078e+02            -inf                  1.4665e+02            7.3518e+01            
17   1.0463e+03            -inf                  2.5118e+02            -inf                  1.9775e+03            2.5336e+03            
18   2.1989e+01            -inf                  2.0804e+01            -inf                  2.5692e+01            2.1735e+01            
19   1.6093e+01            -inf                  1.7759e+01            -inf                  1.4721e+01            1.5667e+01            
20   2.0516e+01            -inf                  2.2408e+01            -inf                  2.1769e+01            2.0681e+01            
21   4.5393e+00            -inf                  4.3962e+00            -inf                  4.5038e+00            4.5112e+00            
22   9.5190e+00            -inf                  8.4669e+00            -inf                  1.0788e+01            9.3251e+00            
23   1.4890e+01            -inf                  1.9349e+01            -inf                  2.1899e+01            1.6578e+01            
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  ...
  Task 10: best error so far = 2.229e+01  (target = 1e-08)
  Task 18: best error so far = 2.080e+01  (target = 1e-08)
  Task 20: best error so far = 2.052e+01  (target = 1e-08)
  Task 12: best error so far = 1.709e+01  (target = 1e-08)
  Task 23: best error so far = 1.489e+01  (target = 1e-08)
  Task 19: best error so far = 1.472e+01  (target = 1e-08)
