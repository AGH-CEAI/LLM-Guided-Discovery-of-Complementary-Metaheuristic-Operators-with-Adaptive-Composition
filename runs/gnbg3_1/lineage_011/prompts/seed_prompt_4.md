...
- CovarianceGuidedDE
- AdaptiveNeighborhoodCMAES
- AdaptiveNeighborhoodBareBonesPSO
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 5.013075e-02
  from lineage 10, cycle 28

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=1.554e-07
  Task  1: error=2.471e-07
  Task  2: error=2.943e-05
  Task  3: error=3.417e-04
  Task  4: error=2.306e-02
  Task  5: SOLVED  (error=1.00e-08)
  Task  6: error=6.997e-06
  Task  7: error=1.385e-05
  Task  8: error=1.815e-03
  Task  9: error=4.976e-04
  Task 10: error=2.243e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=3.485e+01  *** NEEDS IMPROVEMENT ***
  Task 12: error=2.009e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=3.360e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.632e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=2.967e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=8.395e+01  *** NEEDS IMPROVEMENT ***
  Task 17: error=2.993e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.202e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.864e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.089e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.534e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=1.101e+01  *** NEEDS IMPROVEMENT ***
  Task 23: error=1.836e+01  *** NEEDS IMPROVEMENT ***

History stats: 30 cycles, 16 improvements, 0 crashes
Methods that responded well to adaptation:
  ...
  - _initialize_population (2 successful adaptation(s))
