This is iteration 3 of 10. Propose ONE replacement implementation for `_select_mutation_operator_batch`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task 17: *** UNSOLVED *** — best=3.462e+02 by original.py               (target=1e-08, ~+10.5 decades above target)
  Task 19: *** UNSOLVED *** — best=3.237e+02 by original.py               (target=1e-08, ~+10.5 decades above target)
  Task 23: *** UNSOLVED *** — best=5.515e+01 by original.py               (target=1e-08, ~+9.7 decades above target)
  Task  6: *** UNSOLVED *** — best=3.072e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 11: *** UNSOLVED *** — best=2.486e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.4 decades above target)
  Task  5: *** UNSOLVED *** — best=1.829e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 22: *** UNSOLVED *** — best=1.768e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.2 decades above target)
  Task 20: *** UNSOLVED *** — best=1.692e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task 18: *** UNSOLVED *** — best=1.621e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task 14: *** UNSOLVED *** — best=9.805e+00 by original.py               (target=1e-08, ~+9.0 decades above target)
  Task  9: *** UNSOLVED *** — best=8.476e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.9 decades above target)
  Task 21: *** UNSOLVED *** — best=5.030e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.7 decades above target)
  Task  7: *** UNSOLVED *** — best=2.762e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.4 decades above target)
  Task 13: *** UNSOLVED *** — best=2.683e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task 15: *** UNSOLVED *** — best=2.572e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.4 decades above target)
  Task  3: *** UNSOLVED *** — best=2.294e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  8: *** UNSOLVED *** — best=1.089e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.0 decades above target)
  Task  4: *** UNSOLVED *** — best=4.478e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.7 decades above target)
  Task  1: *** UNSOLVED *** — best=1.166e-03 by original.py               (target=1e-08, ~+5.1 decades above target)
  ...
  Task  2: *** UNSOLVED *** — best=8.774e-06 by variant_01_idea_0.py      (target=1e-08, ~+2.9 decades above target)
  Task  0: *** UNSOLVED *** — best=2.838e-08 by variant_01_idea_0.py      (target=1e-08, ~+0.5 decades above target)

PER-TASK BENCHMARK ERRORS (raw numbers, lower is better):
Task original.py           variant_01_idea_0.py  variant_02_idea_0.py  
-----------------------------------------------------------------------
0    3.1042e-08            2.8376e-08            -inf                  
1    1.1662e-03            1.1961e-03            -inf                  
2    8.9327e-06            8.7739e-06            -inf                  
3    2.2938e+00            2.5235e+00            -inf                  
4    5.4752e-02            4.4778e-02            -inf                  
5    5.9273e+01            1.8293e+01            -inf                  
6    3.0724e+01            3.5009e+01            -inf                  
7    2.9816e+00            2.7618e+00            -inf                  
8    1.2852e-01            1.0891e-01            -inf                  
9    8.5701e+00            8.4759e+00            -inf                  
10   1.1661e-04            1.2882e-04            -inf                  
11   3.3030e+01            2.4863e+01            -inf                  
12   8.7372e-04            8.4642e-04            -inf                  
13   2.6831e+00            2.7183e+00            -inf                  
14   9.8051e+00            1.1602e+01            -inf                  
15   2.5845e+00            2.5720e+00            -inf                  
16   1.3044e+03            1.1766e+03            -inf                  
17   3.4620e+02            1.3447e+03            -inf                  
18   1.6209e+01            2.3717e+01            -inf                  
19   3.2374e+02            3.2860e+02            -inf                  
20   1.6921e+01            1.7359e+01            -inf                  
21   5.1572e+00            5.0303e+00            -inf                  
22   1.8156e+01            1.7685e+01            -inf                  
23   5.5147e+01            5.7331e+01            -inf                  
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  ...
  Task 19: best error so far = 3.237e+02  (target = 1e-08)
  Task 23: best error so far = 5.515e+01  (target = 1e-08)
  Task  6: best error so far = 3.072e+01  (target = 1e-08)
  Task 11: best error so far = 2.486e+01  (target = 1e-08)
  Task  5: best error so far = 1.829e+01  (target = 1e-08)
  Task 22: best error so far = 1.768e+01  (target = 1e-08)
