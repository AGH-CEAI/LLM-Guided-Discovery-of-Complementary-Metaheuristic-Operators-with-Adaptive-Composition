This is iteration 2 of 10. Propose ONE replacement implementation for `_clip_to_bounds`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 16: *** UNSOLVED *** — best=8.395e+01 by original.py               (target=1e-08, ~+9.9 decades above target)
  Task 11: *** UNSOLVED *** — best=3.485e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  ...
  Task 18: *** UNSOLVED *** — best=2.202e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 20: *** UNSOLVED *** — best=2.089e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 12: *** UNSOLVED *** — best=2.009e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 19: *** UNSOLVED *** — best=1.864e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 23: *** UNSOLVED *** — best=1.836e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 22: *** UNSOLVED *** — best=1.101e+01 by original.py               (target=1e-08, ~+9.0 decades above target)
  Task 21: *** UNSOLVED *** — best=4.534e+00 by original.py               (target=1e-08, ~+8.7 decades above target)
  Task 13: *** UNSOLVED *** — best=3.360e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task 15: *** UNSOLVED *** — best=2.967e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task 14: *** UNSOLVED *** — best=2.632e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  4: *** UNSOLVED *** — best=2.306e-02 by original.py               (target=1e-08, ~+6.4 decades above target)
  Task  8: *** UNSOLVED *** — best=1.815e-03 by original.py               (target=1e-08, ~+5.3 decades above target)
  Task  9: *** UNSOLVED *** — best=4.976e-04 by original.py               (target=1e-08, ~+4.7 decades above target)
  Task  3: *** UNSOLVED *** — best=3.417e-04 by original.py               (target=1e-08, ~+4.5 decades above target)
  Task  2: *** UNSOLVED *** — best=2.943e-05 by original.py               (target=1e-08, ~+3.5 decades above target)
  Task  7: *** UNSOLVED *** — best=1.385e-05 by original.py               (target=1e-08, ~+3.1 decades above target)
  Task  6: *** UNSOLVED *** — best=6.997e-06 by original.py               (target=1e-08, ~+2.8 decades above target)
  Task  1: *** UNSOLVED *** — best=2.471e-07 by original.py               (target=1e-08, ~+1.4 decades above target)
  Task  0: *** UNSOLVED *** — best=1.554e-07 by original.py               (target=1e-08, ~+1.2 decades above target)
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 16: best error so far = 8.395e+01  (target = 1e-08)
  Task 11: best error so far = 3.485e+01  (target = 1e-08)
  Task 17: best error so far = 2.993e+01  (target = 1e-08)
  Task 10: best error so far = 2.243e+01  (target = 1e-08)
  Task 18: best error so far = 2.202e+01  (target = 1e-08)
  Task 20: best error so far = 2.089e+01  (target = 1e-08)
  Task 12: best error so far = 2.009e+01  (target = 1e-08)
  Task 19: best error so far = 1.864e+01  (target = 1e-08)
