...
- CovarianceGuidedDE
- AdaptiveCovarianceEvolution
- AdaptiveTopologyPSO
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.202406e+00
  from lineage 4, cycle 10

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=5.608e-02
  Task  1: error=4.240e-02
  Task  2: error=1.440e-01
  Task  3: error=1.307e-01
  Task  4: error=5.163e-01
  Task  5: error=8.841e-05
  Task  6: error=1.564e-02
  Task  7: error=7.442e-02
  Task  8: error=2.461e-01
  Task  9: error=7.227e-02
  Task 10: error=1.348e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=4.292e+01  *** NEEDS IMPROVEMENT ***
  Task 12: error=1.745e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=1.698e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.691e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=2.842e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=6.334e+01  *** NEEDS IMPROVEMENT ***
  Task 17: error=3.463e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=1.927e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.773e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.018e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.556e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=1.081e+01  *** NEEDS IMPROVEMENT ***
  Task 23: error=2.019e+01  *** NEEDS IMPROVEMENT ***

History stats: 12 cycles, 8 improvements, 0 crashes
Methods that responded well to adaptation:
  ...
  - _adapt_covariance_variant_08 (1 successful adaptation(s))
