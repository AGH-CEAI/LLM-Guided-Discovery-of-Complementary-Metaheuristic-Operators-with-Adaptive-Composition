...
- AdaptiveDEOptimizer
- CovarianceGuidedNichingOptimizer
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.087118e-01
  from lineage 8, cycle 23

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=5.178e-06
  Task  1: error=7.901e-06
  Task  2: error=1.611e-04
  Task  3: error=1.159e-03
  Task  4: error=5.238e-02
  Task  5: SOLVED  (error=1.00e-08)
  Task  6: error=2.444e-06
  Task  7: error=1.232e-04
  Task  8: error=5.345e-03
  Task  9: error=5.583e-04
  Task 10: error=2.552e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=1.043e+02  *** NEEDS IMPROVEMENT ***
  Task 12: error=3.212e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=4.043e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.666e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=2.814e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=8.085e+01  *** NEEDS IMPROVEMENT ***
  Task 17: error=6.196e+03  *** NEEDS IMPROVEMENT ***
  Task 18: error=1.689e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.049e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.133e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.363e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=7.294e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=1.321e+01  *** NEEDS IMPROVEMENT ***

History stats: 24 cycles, 11 improvements, 0 crashes
Methods that responded well to adaptation:
  ...
  - _compute_diversity (1 successful adaptation(s))
