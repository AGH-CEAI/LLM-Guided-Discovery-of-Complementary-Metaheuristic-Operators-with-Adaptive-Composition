...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 16: *** UNSOLVED *** — best=8.564e+01 by original.py               (target=1e-08, ~+9.9 decades above target)
  ...
  Task  7: *** UNSOLVED *** — best=7.948e-02 by original.py               (target=1e-08, ~+6.9 decades above target)
  Task  9: *** UNSOLVED *** — best=7.223e-02 by original.py               (target=1e-08, ~+6.9 decades above target)
  Task  0: *** UNSOLVED *** — best=5.813e-02 by original.py               (target=1e-08, ~+6.8 decades above target)
  Task  1: *** UNSOLVED *** — best=4.496e-02 by original.py               (target=1e-08, ~+6.7 decades above target)
  Task  6: *** UNSOLVED *** — best=1.546e-02 by original.py               (target=1e-08, ~+6.2 decades above target)
  Task  5: *** UNSOLVED *** — best=1.127e-04 by original.py               (target=1e-08, ~+4.1 decades above target)
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 16: best error so far = 8.564e+01  (target = 1e-08)
