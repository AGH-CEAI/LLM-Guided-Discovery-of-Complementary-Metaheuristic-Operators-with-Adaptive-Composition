...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 16: *** UNSOLVED *** — best=6.271e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.8 decades above target)
  Task 17: *** UNSOLVED *** — best=3.463e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 11: *** UNSOLVED *** — best=3.260e+01 by variant_03_idea_0.py      (target=1e-08, ~+9.5 decades above target)
  Task 20: *** UNSOLVED *** — best=1.847e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 23: *** UNSOLVED *** — best=1.843e+01 by variant_03_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 12: *** UNSOLVED *** — best=1.745e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task 19: *** UNSOLVED *** — best=1.656e+01 by variant_07_idea_0.py      (target=1e-08, ~+9.2 decades above target)
  Task 18: *** UNSOLVED *** — best=1.515e+01 by variant_03_idea_0.py      (target=1e-08, ~+9.2 decades above target)
  Task 10: *** UNSOLVED *** — best=1.348e+01 by original.py               (target=1e-08, ~+9.1 decades above target)
  Task 22: *** UNSOLVED *** — best=9.266e+00 by variant_02_idea_0.py      (target=1e-08, ~+9.0 decades above target)
  Task 21: *** UNSOLVED *** — best=4.517e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.7 decades above target)
  Task 15: *** UNSOLVED *** — best=2.819e+00 by variant_03_idea_0.py      (target=1e-08, ~+8.5 decades above target)
  Task 14: *** UNSOLVED *** — best=2.691e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task 13: *** UNSOLVED *** — best=1.698e+00 by original.py               (target=1e-08, ~+8.2 decades above target)
  Task  4: *** UNSOLVED *** — best=5.033e-01 by variant_02_idea_0.py      (target=1e-08, ~+7.7 decades above target)
  Task  8: *** UNSOLVED *** — best=2.438e-01 by variant_07_idea_0.py      (target=1e-08, ~+7.4 decades above target)
  Task  2: *** UNSOLVED *** — best=1.422e-01 by variant_07_idea_0.py      (target=1e-08, ~+7.2 decades above target)
  Task  3: *** UNSOLVED *** — best=1.248e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.1 decades above target)
  Task  7: *** UNSOLVED *** — best=7.372e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.9 decades above target)
  Task  9: *** UNSOLVED *** — best=7.227e-02 by original.py               (target=1e-08, ~+6.9 decades above target)
  Task  0: *** UNSOLVED *** — best=5.374e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.7 decades above target)
  Task  1: *** UNSOLVED *** — best=3.650e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.6 decades above target)
  Task  6: *** UNSOLVED *** — best=1.466e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.2 decades above target)
  Task  5: *** UNSOLVED *** — best=6.588e-05 by variant_01_idea_0.py      (target=1e-08, ~+3.8 decades above target)

PER-TASK BENCHMARK ERRORS (raw numbers, lower is better):
Task original.py           variant_01_idea_0.py  variant_02_idea_0.py  variant_03_idea_0.py  variant_04_idea_0.py  variant_05_idea_0.py  variant_07_idea_0.py  variant_08_idea_0.py  variant_09_idea_0.py  
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
0    5.6082e-02            5.3736e-02            5.5961e-02            5.6382e-02            -inf                  -inf                  5.5562e-02            -inf                  5.3953e-02            
1    4.2404e-02            3.6501e-02            4.2585e-02            4.0461e-02            -inf                  -inf                  4.1323e-02            -inf                  4.2286e-02            
2    1.4404e-01            1.4656e-01            1.4227e-01            1.4268e-01            -inf                  -inf                  1.4221e-01            -inf                  1.6254e-01            
3    1.3071e-01            1.2485e-01            1.3055e-01            1.2777e-01            -inf                  -inf                  1.2976e-01            -inf                  1.3758e-01            
4    5.1627e-01            5.0988e-01            5.0331e-01            5.1279e-01            -inf                  -inf                  5.0521e-01            -inf                  5.1132e-01            
5    8.8407e-05            6.5877e-05            8.2229e-05            6.9986e-05            -inf                  -inf                  7.5254e-05            -inf                  8.0522e-05            
6    1.5643e-02            1.4663e-02            1.5305e-02            1.5441e-02            -inf                  -inf                  1.5061e-02            -inf                  1.5169e-02            
7    7.4424e-02            7.3722e-02            7.3980e-02            7.5500e-02            -inf                  -inf                  7.5099e-02            -inf                  8.1183e-02            
8    2.4606e-01            2.4868e-01            2.4608e-01            2.4953e-01            -inf                  -inf                  2.4382e-01            -inf                  2.5162e-01            
9    7.2267e-02            7.6405e-02            9.5539e-02            8.6582e-02            -inf                  -inf                  7.3904e-02            -inf                  4.4171e-01            
10   1.3483e+01            1.9943e+01            3.3328e+01            1.5513e+01            -inf                  -inf                  3.0554e+01            -inf                  2.6451e+01            
11   4.2924e+01            3.4229e+01            7.2753e+01            3.2604e+01            -inf                  -inf                  7.1333e+01            -inf                  7.1576e+01            
12   1.7455e+01            2.2467e+01            3.3188e+01            1.9849e+01            -inf                  -inf                  3.0291e+01            -inf                  1.7471e+01            
13   1.6981e+00            3.3014e+00            6.3738e+00            2.1356e+00            -inf                  -inf                  4.7972e+00            -inf                  4.7381e+00            
14   2.6910e+00            2.7981e+00            2.7798e+00            2.7690e+00            -inf                  -inf                  2.7721e+00            -inf                  2.9915e+00            
15   2.8419e+00            2.8521e+00            3.0979e+00            2.8189e+00            -inf                  -inf                  3.0087e+00            -inf                  2.9809e+00            
16   6.3336e+01            6.2711e+01            6.7157e+01            6.5648e+01            -inf                  -inf                  6.4030e+01            -inf                  6.4827e+01            
17   3.4626e+01            4.8525e+01            6.9286e+02            6.8770e+01            -inf                  -inf                  2.0413e+02            -inf                  3.5030e+02            
18   1.9271e+01            2.0202e+01            2.3514e+01            1.5148e+01            -inf                  -inf                  2.8021e+01            -inf                  2.1157e+01            
19   1.7725e+01            2.0196e+01            2.3204e+01            1.9371e+01            -inf                  -inf                  1.6559e+01            -inf                  2.0491e+01            
20   2.0180e+01            1.8466e+01            1.8629e+01            1.9364e+01            -inf                  -inf                  1.9067e+01            -inf                  1.8506e+01            
21   4.5560e+00            4.5365e+00            4.5174e+00            4.6135e+00            -inf                  -inf                  4.5397e+00            -inf                  4.5827e+00            
22   1.0808e+01            1.1214e+01            9.2660e+00            9.6943e+00            -inf                  -inf                  9.4056e+00            -inf                  9.8521e+00            
23   2.0188e+01            2.1423e+01            1.9086e+01            1.8431e+01            -inf                  -inf                  2.2612e+01            -inf                  2.0902e+01            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 16: best error so far = 6.271e+01  (target = 1e-08)
  Task 17: best error so far = 3.463e+01  (target = 1e-08)
  Task 11: best error so far = 3.260e+01  (target = 1e-08)
  Task 20: best error so far = 1.847e+01  (target = 1e-08)
  Task 23: best error so far = 1.843e+01  (target = 1e-08)
  Task 12: best error so far = 1.745e+01  (target = 1e-08)
  Task 19: best error so far = 1.656e+01  (target = 1e-08)
  Task 18: best error so far = 1.515e+01  (target = 1e-08)
