This is iteration 4 of 10. Propose ONE replacement implementation for `_apply_local_refinement`.

Requirements:
- Keep the EXACT function signature: `def _apply_local_refinement(self, population, fitness, func):`
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 16: *** UNSOLVED *** — best=1.355e+03 by variant_02_idea_0.py      (target=1e-08, ~+11.1 decades above target)
  Task 19: *** UNSOLVED *** — best=3.199e+02 by original.py               (target=1e-08, ~+10.5 decades above target)
  Task 23: *** UNSOLVED *** — best=5.978e+01 by original.py               (target=1e-08, ~+9.8 decades above target)
  Task 17: *** UNSOLVED *** — best=5.850e+01 by original.py               (target=1e-08, ~+9.8 decades above target)
  Task  6: *** UNSOLVED *** — best=3.002e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 11: *** UNSOLVED *** — best=2.907e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 18: *** UNSOLVED *** — best=2.474e+01 by original.py               (target=1e-08, ~+9.4 decades above target)
  Task 22: *** UNSOLVED *** — best=1.791e+01 by variant_02_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 20: *** UNSOLVED *** — best=1.637e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task 14: *** UNSOLVED *** — best=9.169e+00 by variant_02_idea_0.py      (target=1e-08, ~+9.0 decades above target)
  Task  9: *** UNSOLVED *** — best=8.527e+00 by original.py               (target=1e-08, ~+8.9 decades above target)
  Task 21: *** UNSOLVED *** — best=5.021e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.7 decades above target)
  Task 13: *** UNSOLVED *** — best=2.636e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task 15: *** UNSOLVED *** — best=2.527e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  7: *** UNSOLVED *** — best=2.330e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  3: *** UNSOLVED *** — best=1.309e+00 by variant_01_idea_0.py      (target=1e-08, ~+8.1 decades above target)
  Task  5: *** UNSOLVED *** — best=4.770e-01 by variant_02_idea_0.py      (target=1e-08, ~+7.7 decades above target)
  Task  8: *** UNSOLVED *** — best=1.240e-01 by original.py               (target=1e-08, ~+7.1 decades above target)
  Task  4: *** UNSOLVED *** — best=4.945e-02 by original.py               (target=1e-08, ~+6.7 decades above target)
  Task  1: *** UNSOLVED *** — best=1.112e-03 by variant_02_idea_0.py      (target=1e-08, ~+5.0 decades above target)
  Task 12: *** UNSOLVED *** — best=8.029e-04 by variant_02_idea_0.py      (target=1e-08, ~+4.9 decades above target)
  Task 10: *** UNSOLVED *** — best=1.266e-04 by original.py               (target=1e-08, ~+4.1 decades above target)
  Task  2: *** UNSOLVED *** — best=7.510e-06 by original.py               (target=1e-08, ~+2.9 decades above target)
  Task  0: *** UNSOLVED *** — best=2.442e-08 by original.py               (target=1e-08, ~+0.4 decades above target)
...
---------------------------------------------------------------------------------------------
0    2.4423e-08            5.3512e-06            2.5918e-08            8.3298e-01            
1    1.1874e-03            5.4098e+00            1.1118e-03            7.6278e+00            
2    7.5095e-06            1.3969e-04            9.1124e-06            1.3187e+01            
3    2.0003e+00            1.3093e+00            2.0526e+00            3.7621e+01            
4    4.9454e-02            1.7124e+00            5.5782e-02            2.0133e+00            
5    3.8818e+01            3.5505e+02            4.7696e-01            3.7934e+05            
6    3.0021e+01            1.2582e+02            3.4733e+01            6.2615e+02            
7    2.3300e+00            4.5822e+00            4.2492e+00            2.9597e+01            
8    1.2398e-01            2.0652e+00            1.3672e-01            1.0594e+01            
9    8.5271e+00            1.6461e+01            8.7952e+00            6.0009e+01            
10   1.2659e-04            3.8520e-04            1.2669e-04            4.8586e+01            
11   2.9066e+01            5.8179e+02            1.1441e+02            8.9874e+02            
12   8.5435e-04            7.7278e-03            8.0290e-04            9.2335e+01            
13   2.6364e+00            2.5856e+01            3.2017e+00            3.3687e+01            
14   9.4079e+00            1.9703e+01            9.1688e+00            9.4176e+00            
15   2.5266e+00            4.0341e+00            2.7059e+00            4.2047e+00            
16   2.6713e+03            2.8787e+04            1.3549e+03            2.1056e+03            
17   5.8502e+01            2.6443e+04            1.4787e+03            7.1409e+04            
18   2.4742e+01            4.6650e+01            2.4897e+01            5.4467e+01            
19   3.1993e+02            5.8787e+02            4.0875e+02            4.0033e+02            
20   1.6369e+01            5.6869e+01            1.9350e+01            3.1994e+01            
21   5.0400e+00            5.6865e+00            5.0210e+00            5.4216e+00            
22   1.8018e+01            1.9341e+01            1.7911e+01            2.0107e+01            
23   5.9776e+01            9.9836e+01            7.8511e+01            1.4295e+02            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 16: best error so far = 1.355e+03  (target = 1e-08)
  Task 19: best error so far = 3.199e+02  (target = 1e-08)
  Task 23: best error so far = 5.978e+01  (target = 1e-08)
  Task 17: best error so far = 5.850e+01  (target = 1e-08)
  Task  6: best error so far = 3.002e+01  (target = 1e-08)
  Task 11: best error so far = 2.907e+01  (target = 1e-08)
  Task 18: best error so far = 2.474e+01  (target = 1e-08)
  Task 22: best error so far = 1.791e+01  (target = 1e-08)
...
```python
def _apply_local_refinement(self, ...):
    ...
```