This is iteration 4 of 10. Propose ONE replacement implementation for `_adapt_step_size`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 17: *** UNSOLVED *** — best=4.185e+02 by variant_02_idea_0.py      (target=1e-08, ~+10.6 decades above target)
  Task 16: *** UNSOLVED *** — best=1.240e+02 by variant_02_idea_0.py      (target=1e-08, ~+10.1 decades above target)
  Task 19: *** UNSOLVED *** — best=2.893e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.5 decades above target)
  Task 11: *** UNSOLVED *** — best=2.694e+01 by original.py               (target=1e-08, ~+9.4 decades above target)
  Task 10: *** UNSOLVED *** — best=2.331e+01 by original.py               (target=1e-08, ~+9.4 decades above target)
  Task 12: *** UNSOLVED *** — best=2.221e+01 by variant_02_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 23: *** UNSOLVED *** — best=2.208e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 20: *** UNSOLVED *** — best=2.145e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  ...
  Task 14: *** UNSOLVED *** — best=2.890e+00 by variant_02_idea_0.py      (target=1e-08, ~+8.5 decades above target)
  Task 13: *** UNSOLVED *** — best=2.825e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task 15: *** UNSOLVED *** — best=2.720e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  4: *** UNSOLVED *** — best=5.188e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.7 decades above target)
  Task  8: *** UNSOLVED *** — best=4.396e-01 by variant_01_idea_0.py      (target=1e-08, ~+7.6 decades above target)
  Task  3: *** UNSOLVED *** — best=2.967e-01 by original.py               (target=1e-08, ~+7.5 decades above target)
  ...
  Task  6: *** UNSOLVED *** — best=8.557e-02 by original.py               (target=1e-08, ~+6.9 decades above target)
  Task  9: *** UNSOLVED *** — best=7.997e-02 by original.py               (target=1e-08, ~+6.9 decades above target)
  Task  0: *** UNSOLVED *** — best=5.647e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.8 decades above target)
  Task  1: *** UNSOLVED *** — best=4.478e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.7 decades above target)
...
---------------------------------------------------------------------------------------------
0    5.9809e-02            5.6474e-02            6.2026e-02            -inf                  
1    4.5735e-02            4.4783e-02            1.0410e-01            -inf                  
2    1.4822e-01            2.3034e-01            1.9122e+00            -inf                  
3    2.9670e-01            9.2139e-01            2.6581e+00            -inf                  
4    5.2271e-01            5.1882e-01            6.8334e-01            -inf                  
5    1.0522e-04            1.7665e-04            1.3643e+00            -inf                  
6    8.5569e-02            2.4651e+01            6.0672e+00            -inf                  
7    1.0680e-01            2.3301e-01            6.2474e-01            -inf                  
8    7.0862e-01            4.3965e-01            1.5392e+00            -inf                  
9    7.9966e-02            6.8571e+00            6.8144e+00            -inf                  
10   2.3314e+01            2.8640e+01            4.0925e+01            -inf                  
11   2.6936e+01            9.3385e+01            3.0123e+01            -inf                  
12   2.4142e+01            3.1378e+01            2.2213e+01            -inf                  
13   2.8246e+00            4.2162e+00            3.6966e+00            -inf                  
14   2.9569e+00            3.0192e+00            2.8897e+00            -inf                  
15   2.7197e+00            2.8649e+00            2.7920e+00            -inf                  
16   1.3804e+02            1.5053e+02            1.2401e+02            -inf                  
17   5.5732e+02            2.6258e+03            4.1851e+02            -inf                  
18   2.0029e+01            2.3238e+01            2.1503e+01            -inf                  
19   2.9667e+01            2.8933e+01            3.2685e+01            -inf                  
20   2.2665e+01            2.1449e+01            2.1979e+01            -inf                  
21   4.4242e+00            4.5787e+00            4.4169e+00            -inf                  
22   7.7674e+00            1.1661e+01            1.1103e+01            -inf                  
23   2.2084e+01            2.2707e+01            2.2210e+01            -inf                  

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 4.185e+02  (target = 1e-08)
  Task 16: best error so far = 1.240e+02  (target = 1e-08)
  Task 19: best error so far = 2.893e+01  (target = 1e-08)
  Task 11: best error so far = 2.694e+01  (target = 1e-08)
  Task 10: best error so far = 2.331e+01  (target = 1e-08)
  Task 12: best error so far = 2.221e+01  (target = 1e-08)
  Task 23: best error so far = 2.208e+01  (target = 1e-08)
  Task 20: best error so far = 2.145e+01  (target = 1e-08)
