...
class AdaptiveCovarianceEvolutionStrategy:
    ...
    Features:
    - 8 step-size adaptation strategies (original + 7 best-performing variants)
    ...
    def __init__(self, dim, *args, **kwargs):
        ...
        # Adaptive step-size operator selection parameters
    ...
    def _reset_operator_state(self):
        ...
        # Reset step-size adaptation state
    ...
    def _adapt_step_size_variant_01(self):
        ...
        ps_norm = np.linalg.norm(self.ps_path)
