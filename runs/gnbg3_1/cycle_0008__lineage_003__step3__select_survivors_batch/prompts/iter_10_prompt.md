...
Requirements:
- Keep the EXACT function signature: `def _select_survivors_batch(self):`
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 16: *** UNSOLVED *** — best=9.906e+01 by variant_09_idea_0.py      (target=1e-08, ~+10.0 decades above target)
  Task 17: *** UNSOLVED *** — best=3.085e+01 by variant_05_idea_0.py      (target=1e-08, ~+9.5 decades above target)
  Task 20: *** UNSOLVED *** — best=2.055e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 12: *** UNSOLVED *** — best=1.844e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 23: *** UNSOLVED *** — best=1.746e+01 by variant_05_idea_0.py      (target=1e-08, ~+9.2 decades above target)
  Task 18: *** UNSOLVED *** — best=1.701e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task 19: *** UNSOLVED *** — best=1.653e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task 10: *** UNSOLVED *** — best=1.554e+01 by variant_05_idea_0.py      (target=1e-08, ~+9.2 decades above target)
  Task 11: *** UNSOLVED *** — best=1.165e+01 by variant_09_idea_0.py      (target=1e-08, ~+9.1 decades above target)
  Task 22: *** UNSOLVED *** — best=7.998e+00 by variant_09_idea_0.py      (target=1e-08, ~+8.9 decades above target)
  Task 21: *** UNSOLVED *** — best=4.510e+00 by original.py               (target=1e-08, ~+8.7 decades above target)
  Task 13: *** UNSOLVED *** — best=2.988e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task 14: *** UNSOLVED *** — best=2.851e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task 15: *** UNSOLVED *** — best=2.805e+00 by variant_09_idea_0.py      (target=1e-08, ~+8.4 decades above target)
  Task  4: *** UNSOLVED *** — best=5.065e-01 by variant_05_idea_0.py      (target=1e-08, ~+7.7 decades above target)
  Task  2: *** UNSOLVED *** — best=2.878e-01 by original.py               (target=1e-08, ~+7.5 decades above target)
  Task  8: *** UNSOLVED *** — best=2.511e-01 by original.py               (target=1e-08, ~+7.4 decades above target)
  Task  3: *** UNSOLVED *** — best=1.348e-01 by original.py               (target=1e-08, ~+7.1 decades above target)
  Task  7: *** UNSOLVED *** — best=8.004e-02 by original.py               (target=1e-08, ~+6.9 decades above target)
  Task  9: *** UNSOLVED *** — best=7.032e-02 by original.py               (target=1e-08, ~+6.8 decades above target)
  Task  0: *** UNSOLVED *** — best=5.179e-02 by variant_07_idea_0.py      (target=1e-08, ~+6.7 decades above target)
  Task  6: *** UNSOLVED *** — best=4.082e-02 by original.py               (target=1e-08, ~+6.6 decades above target)
  Task  1: *** UNSOLVED *** — best=3.549e-02 by variant_05_idea_0.py      (target=1e-08, ~+6.6 decades above target)
  Task  5: *** UNSOLVED *** — best=9.227e-05 by original.py               (target=1e-08, ~+4.0 decades above target)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
0    5.3145e-02            -inf                  5.5350e-02            5.4100e+00            -inf                  5.5232e-02            5.1789e-02            2.5312e+00            5.9361e-02            
1    4.4470e-02            -inf                  4.3866e-02            9.3844e+00            -inf                  3.5491e-02            3.7849e-02            3.0770e+01            4.7113e-02            
2    2.8776e-01            -inf                  3.8997e+00            5.1147e+01            -inf                  8.2193e-01            4.4797e+00            2.9603e+00            3.4868e+00            
3    1.3475e-01            -inf                  3.2009e+00            4.4486e+01            -inf                  2.3562e+00            2.8107e+00            8.7594e+01            3.0620e+00            
4    5.2319e-01            -inf                  5.2228e-01            2.3286e+00            -inf                  5.0647e-01            5.4303e-01            2.2029e+00            1.4485e+00            
5    9.2270e-05            -inf                  1.2029e-03            3.9816e+05            -inf                  2.0513e-04            1.2487e-03            7.4367e+07            1.8585e-04            
6    4.0821e-02            -inf                  2.0974e+01            1.5943e+02            -inf                  2.8723e+01            1.0599e+01            1.1411e+03            1.2407e+00            
7    8.0036e-02            -inf                  1.9217e-01            3.5731e+01            -inf                  1.9386e-01            2.0688e-01            8.0148e+01            2.5544e+00            
8    2.5109e-01            -inf                  9.6313e-01            1.1212e+01            -inf                  3.1907e-01            1.8007e+00            1.1127e+01            1.7752e+00            
9    7.0315e-02            -inf                  4.6433e-01            1.3837e+01            -inf                  3.2771e+00            5.1884e+00            7.6469e+01            7.2154e+00            
10   1.8805e+01            -inf                  6.9664e+01            6.5491e+01            -inf                  1.5537e+01            1.4321e+02            2.3035e+02            2.6985e+01            
11   1.5985e+01            -inf                  1.8096e+02            2.3728e+02            -inf                  1.3445e+01            4.0824e+02            7.4822e+02            1.1645e+01            
12   1.8435e+01            -inf                  8.1935e+01            8.0320e+01            -inf                  1.8978e+01            1.2125e+02            2.1962e+02            2.7034e+01            
13   2.9883e+00            -inf                  1.6404e+01            1.6125e+01            -inf                  3.7050e+00            2.3530e+01            3.1598e+01            3.3712e+00            
14   2.8511e+00            -inf                  3.1904e+00            6.4112e+00            -inf                  2.8971e+00            3.9685e+00            9.0446e+00            2.8969e+00            
15   2.8145e+00            -inf                  3.3231e+00            3.4960e+00            -inf                  3.0763e+00            3.8569e+00            4.0517e+00            2.8050e+00            
16   1.0729e+02            -inf                  3.7657e+02            4.4967e+02            -inf                  2.5470e+02            3.0491e+02            4.8541e+03            9.9062e+01            
17   4.1808e+01            -inf                  1.5099e+04            2.4006e+04            -inf                  3.0854e+01            4.0379e+04            1.6664e+05            1.1491e+03            
18   1.7011e+01            -inf                  3.1941e+01            3.9679e+01            -inf                  2.1919e+01            4.4090e+01            6.8308e+01            2.0069e+01            
19   1.6526e+01            -inf                  5.2908e+01            8.9480e+01            -inf                  2.4590e+01            1.1228e+02            2.3225e+02            2.6336e+01            
20   2.0552e+01            -inf                  2.9724e+01            2.9045e+01            -inf                  2.2705e+01            3.1980e+01            3.8135e+01            2.2790e+01            
21   4.5097e+00            -inf                  4.6515e+00            5.2496e+00            -inf                  4.5318e+00            5.0689e+00            5.6407e+00            4.5999e+00            
22   8.0704e+00            -inf                  1.2403e+01            1.2850e+01            -inf                  1.1955e+01            1.3417e+01            1.7288e+01            7.9978e+00            
23   1.9771e+01            -inf                  2.6018e+01            2.8156e+01            -inf                  1.7459e+01            4.1630e+01            5.7655e+01            2.1207e+01            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 16: best error so far = 9.906e+01  (target = 1e-08)
  Task 17: best error so far = 3.085e+01  (target = 1e-08)
  Task 20: best error so far = 2.055e+01  (target = 1e-08)
  Task 12: best error so far = 1.844e+01  (target = 1e-08)
  Task 23: best error so far = 1.746e+01  (target = 1e-08)
  Task 18: best error so far = 1.701e+01  (target = 1e-08)
  Task 19: best error so far = 1.653e+01  (target = 1e-08)
  Task 10: best error so far = 1.554e+01  (target = 1e-08)
