...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task  4: *** UNSOLVED *** — best=5.232e-01 by original.py               (target=1e-08, ~+7.7 decades above target)
  ...
  Task  1: *** UNSOLVED *** — best=4.447e-02 by original.py               (target=1e-08, ~+6.6 decades above target)
