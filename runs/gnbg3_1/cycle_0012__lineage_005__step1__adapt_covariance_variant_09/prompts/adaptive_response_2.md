...
class AdaptiveCovarianceEvolutionStrategy:
    ...
    def __init__(self, dim, *args, **kwargs):
        ...
        # Using 8 operators based on benchmark winning variants
        self.num_operators = 8
        self.operator_names = [
            'original', 
            'variant_01',  # sep-CMA-ES
            'variant_02',  # Hierarchical stagnation detection
            'variant_04',  # Immediate stagnation-triggered reset
            'variant_05',  # Eigenspace diversity-driven
            'variant_07',  # Eigenvalue-aware anisotropic stretching
            'variant_08',  # Restart-triggered covariance shattering
            'variant_09'   # Eigenvalue-weighted with diversity
        ]
    ...
    def _reset_operator_state(self):
        ...
        for attr in ['recent_improvements', 'stagnation_levels', 'eigenspace_history', 
                     'prev_f_opt_es', 'prev_fitness_improvements', 'archive_positions',
                     'archive_fitness', 'archive_generations', 'exploration_temp']:
