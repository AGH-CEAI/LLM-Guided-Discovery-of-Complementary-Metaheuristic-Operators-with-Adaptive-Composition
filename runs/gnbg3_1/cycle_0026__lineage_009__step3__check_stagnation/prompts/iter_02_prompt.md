This is iteration 2 of 10. Propose ONE replacement implementation for `_check_stagnation`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task 17: *** UNSOLVED *** — best=5.388e+02 by original.py               (target=1e-08, ~+10.7 decades above target)
  Task 16: *** UNSOLVED *** — best=7.472e+01 by original.py               (target=1e-08, ~+9.9 decades above target)
  Task 11: *** UNSOLVED *** — best=4.229e+01 by original.py               (target=1e-08, ~+9.6 decades above target)
  Task 10: *** UNSOLVED *** — best=3.936e+01 by original.py               (target=1e-08, ~+9.6 decades above target)
  Task 12: *** UNSOLVED *** — best=3.064e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 19: *** UNSOLVED *** — best=3.035e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 23: *** UNSOLVED *** — best=2.246e+01 by original.py               (target=1e-08, ~+9.4 decades above target)
  Task 20: *** UNSOLVED *** — best=2.204e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  ...
  Task 13: *** UNSOLVED *** — best=4.538e+00 by original.py               (target=1e-08, ~+8.7 decades above target)
  Task 21: *** UNSOLVED *** — best=4.491e+00 by original.py               (target=1e-08, ~+8.7 decades above target)
  Task 15: *** UNSOLVED *** — best=3.141e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task 14: *** UNSOLVED *** — best=2.676e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  Task  4: *** UNSOLVED *** — best=2.320e-02 by original.py               (target=1e-08, ~+6.4 decades above target)
  ...
  Task  2: *** UNSOLVED *** — best=5.423e-05 by original.py               (target=1e-08, ~+3.7 decades above target)
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 5.388e+02  (target = 1e-08)
  Task 16: best error so far = 7.472e+01  (target = 1e-08)
  Task 11: best error so far = 4.229e+01  (target = 1e-08)
  Task 10: best error so far = 3.936e+01  (target = 1e-08)
  Task 12: best error so far = 3.064e+01  (target = 1e-08)
  Task 19: best error so far = 3.035e+01  (target = 1e-08)
  Task 23: best error so far = 2.246e+01  (target = 1e-08)
  Task 20: best error so far = 2.204e+01  (target = 1e-08)
