...
- CMAMemeticOptimizer
- TopologyAwareSwarmOptimizer
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.308300e+00
  from lineage 3, cycle 6

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=5.314e-02
  Task  1: error=4.447e-02
  Task  2: error=2.878e-01
  Task  3: error=1.348e-01
  Task  4: error=5.232e-01
  Task  5: error=9.227e-05
  Task  6: error=4.082e-02
  Task  7: error=8.004e-02
  Task  8: error=2.511e-01
  Task  9: error=7.032e-02
  Task 10: error=1.880e+01  *** NEEDS IMPROVEMENT ***
  Task 11: error=1.598e+01  *** NEEDS IMPROVEMENT ***
  Task 12: error=1.844e+01  *** NEEDS IMPROVEMENT ***
  Task 13: error=2.988e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.851e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=2.814e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=1.073e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=4.181e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=1.701e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.653e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=2.055e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.510e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=8.070e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=1.977e+01  *** NEEDS IMPROVEMENT ***

History stats: 9 cycles, 6 improvements, 0 crashes
Methods that responded well to adaptation:
  ...
  - _adapt_covariance_variant_01 (1 successful adaptation(s))
