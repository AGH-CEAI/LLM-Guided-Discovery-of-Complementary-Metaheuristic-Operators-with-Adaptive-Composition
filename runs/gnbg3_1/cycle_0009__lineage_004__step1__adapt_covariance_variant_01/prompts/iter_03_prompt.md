...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task 18: *** UNSOLVED *** — best=2.187e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 19: *** UNSOLVED *** — best=1.969e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 10: *** UNSOLVED *** — best=1.885e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 20: *** UNSOLVED *** — best=1.874e+01 by variant_01_idea_0.py      (target=1e-08, ~+9.3 decades above target)
  Task 12: *** UNSOLVED *** — best=1.855e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  ...
  Task 13: *** UNSOLVED *** — best=2.837e+00 by original.py               (target=1e-08, ~+8.5 decades above target)
  Task 14: *** UNSOLVED *** — best=2.748e+00 by original.py               (target=1e-08, ~+8.4 decades above target)
  ...
  Task  1: *** UNSOLVED *** — best=4.245e-02 by variant_01_idea_0.py      (target=1e-08, ~+6.6 decades above target)
  Task  6: *** UNSOLVED *** — best=1.495e-02 by original.py               (target=1e-08, ~+6.2 decades above target)
  Task  5: *** UNSOLVED *** — best=9.922e-05 by original.py               (target=1e-08, ~+4.0 decades above target)

PER-TASK BENCHMARK ERRORS (raw numbers, lower is better):
Task original.py           variant_01_idea_0.py  variant_02_idea_0.py  
-----------------------------------------------------------------------
0    5.1986e-02            5.6112e-02            -inf                  
1    4.4597e-02            4.2445e-02            -inf                  
2    4.5557e-01            1.5267e-01            -inf                  
3    1.7765e-01            1.3155e-01            -inf                  
4    5.1232e-01            5.1958e-01            -inf                  
5    9.9221e-05            1.0208e-04            -inf                  
6    1.4949e-02            1.5082e-02            -inf                  
7    2.8111e-01            7.6664e-02            -inf                  
8    2.6339e-01            2.4881e-01            -inf                  
9    1.2552e-01            7.0154e-02            -inf                  
10   1.8846e+01            2.1790e+01            -inf                  
11   1.5987e+01            6.5240e+01            -inf                  
12   1.8548e+01            2.6011e+01            -inf                  
13   2.8368e+00            3.3572e+00            -inf                  
14   2.7475e+00            2.7590e+00            -inf                  
15   2.7843e+00            2.6541e+00            -inf                  
16   1.2139e+02            8.2472e+01            -inf                  
17   3.8698e+01            5.0203e+02            -inf                  
18   2.1867e+01            2.2849e+01            -inf                  
19   1.9690e+01            2.2511e+01            -inf                  
20   2.1339e+01            1.8737e+01            -inf                  
21   4.4631e+00            4.2950e+00            -inf                  
22   8.5996e+00            6.7738e+00            -inf                  
23   1.7215e+01            2.0907e+01            -inf                  
...
PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  ...
  Task 18: best error so far = 2.187e+01  (target = 1e-08)
  Task 19: best error so far = 1.969e+01  (target = 1e-08)
  Task 10: best error so far = 1.885e+01  (target = 1e-08)
  Task 20: best error so far = 1.874e+01  (target = 1e-08)
  Task 12: best error so far = 1.855e+01  (target = 1e-08)
