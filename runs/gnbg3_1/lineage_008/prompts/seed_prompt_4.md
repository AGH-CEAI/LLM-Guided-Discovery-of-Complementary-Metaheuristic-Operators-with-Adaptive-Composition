...
- AdaptiveCovarianceMatrixSearchWithOperatorPool
- TopologyAdaptiveParticleSwarmOptimizer
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 1.028790e+00
  from lineage 7, cycle 19

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=5.900e-02
  Task  1: error=4.274e-02
  Task  2: error=1.706e-01
  Task  3: error=1.381e-01
  Task  4: error=5.142e-01
  Task  5: error=8.859e-05
  Task  6: error=1.584e-02
  Task  7: error=7.836e-02
  Task  8: error=2.635e-01
  Task  9: error=6.832e-02
  Task 10: error=8.491e+00  *** NEEDS IMPROVEMENT ***
  Task 11: error=7.715e+00  *** NEEDS IMPROVEMENT ***
  Task 12: error=8.693e+00  *** NEEDS IMPROVEMENT ***
  Task 13: error=1.851e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.748e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=2.585e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=5.179e+01  *** NEEDS IMPROVEMENT ***
  Task 17: error=3.571e+01  *** NEEDS IMPROVEMENT ***
  Task 18: error=1.113e+01  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.300e+01  *** NEEDS IMPROVEMENT ***
  Task 20: error=1.845e+01  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.340e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=9.802e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=2.079e+01  *** NEEDS IMPROVEMENT ***

History stats: 21 cycles, 10 improvements, 0 crashes
