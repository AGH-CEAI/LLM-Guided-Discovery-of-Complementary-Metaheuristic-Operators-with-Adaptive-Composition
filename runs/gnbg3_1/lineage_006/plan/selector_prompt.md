...
CANDIDATE methods (you MUST pick exactly 3 distinct names from this list):
  ...
  - _select_survivors_batch  (12 LOC)
  - _adapt_covariance  (12 LOC)
  - _adapt_covariance_original  (16 LOC)
...
(no prior cycles in this lineage)
  ...
  Methods excluded (already picked 2+ times globally): _adapt_covariance_variant_01, _adapt_covariance_variant_06, _adapt_covariance_variant_08, _adapt_covariance_variant_09, _adapt_step_size, _sample_trials_batch
