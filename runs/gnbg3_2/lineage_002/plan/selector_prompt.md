...
CANDIDATE methods with metadata (you MUST pick exactly 3 distinct names):
  ...
  -------------------------------------------- ------------ ---- -----------------------------------
  _clip_to_bounds                              observer     3    PURE_observer  called_by=[_initialize_population, _evaluate_batch]
  _compute_diversity                           observer     5    PURE_observer  called_by=[_restart_if_stagnant]
  _build_ring_topology                         observer     6    PURE_observer  called_by=[_optimize]
  _compute_population_centroid                 observer     6    PURE_observer  called_by=[_mutate_batch]
  _evaluate_batch                              observer     12   PURE_observer  called_by=[_optimize]
  _update_direction_memory                     control_flow 13   called_by=[_optimize]
  _compute_directional_bias                    observer     13   PURE_observer  called_by=[_mutate_batch]
  _initialize_population                       observer     19   PURE_observer  called_by=[_optimize]
  _crossover_batch                             observer     20   PURE_observer  called_by=[_optimize]
  _restart_if_stagnant                         control_flow 30   called_by=[_optimize]
  _select_survivors_batch                      observer     39   PURE_observer  called_by=[_optimize]
  _optimize                                    control_flow 57   called_by=[__call__]
  _adapt_parameters                            leaf         63   called_by=[_optimize]
...
(no prior cycles in this lineage)
  ...
  Methods excluded (banned: weighted cost >= 2.0 OR rejected streak >= 3): _mutate_batch
