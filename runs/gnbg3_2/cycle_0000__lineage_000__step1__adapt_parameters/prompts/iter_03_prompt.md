...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  Task  5: *** UNSOLVED *** — best=1.897e+05 by original.py               (target=1e-08, ~+13.3 decades above target)
  Task 17: *** UNSOLVED *** — best=1.768e+05 by original.py               (target=1e-08, ~+13.2 decades above target)
  Task 16: *** UNSOLVED *** — best=4.037e+03 by original.py               (target=1e-08, ~+11.6 decades above target)
  Task 11: *** UNSOLVED *** — best=6.825e+02 by original.py               (target=1e-08, ~+10.8 decades above target)
  Task  6: *** UNSOLVED *** — best=5.951e+02 by original.py               (target=1e-08, ~+10.8 decades above target)
  Task 19: *** UNSOLVED *** — best=1.655e+02 by original.py               (target=1e-08, ~+10.2 decades above target)
  Task  2: *** UNSOLVED *** — best=1.377e+02 by original.py               (target=1e-08, ~+10.1 decades above target)
  Task 18: *** UNSOLVED *** — best=7.584e+01 by original.py               (target=1e-08, ~+9.9 decades above target)
  Task  9: *** UNSOLVED *** — best=4.975e+01 by original.py               (target=1e-08, ~+9.7 decades above target)
  Task 23: *** UNSOLVED *** — best=3.759e+01 by original.py               (target=1e-08, ~+9.6 decades above target)
  Task  3: *** UNSOLVED *** — best=3.628e+01 by original.py               (target=1e-08, ~+9.6 decades above target)
  Task  7: *** UNSOLVED *** — best=3.513e+01 by original.py               (target=1e-08, ~+9.5 decades above target)
  Task 13: *** UNSOLVED *** — best=2.785e+01 by original.py               (target=1e-08, ~+9.4 decades above target)
  Task 10: *** UNSOLVED *** — best=2.368e+01 by original.py               (target=1e-08, ~+9.4 decades above target)
  Task 12: *** UNSOLVED *** — best=2.248e+01 by original.py               (target=1e-08, ~+9.4 decades above target)
  Task 20: *** UNSOLVED *** — best=2.019e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task 22: *** UNSOLVED *** — best=1.720e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task  0: *** UNSOLVED *** — best=1.464e+01 by original.py               (target=1e-08, ~+9.2 decades above target)
  Task  8: *** UNSOLVED *** — best=1.065e+01 by original.py               (target=1e-08, ~+9.0 decades above target)
  Task  1: *** UNSOLVED *** — best=1.064e+01 by original.py               (target=1e-08, ~+9.0 decades above target)
  Task 14: *** UNSOLVED *** — best=6.198e+00 by original.py               (target=1e-08, ~+8.8 decades above target)
  Task 21: *** UNSOLVED *** — best=5.887e+00 by original.py               (target=1e-08, ~+8.8 decades above target)
  Task 15: *** UNSOLVED *** — best=3.903e+00 by original.py               (target=1e-08, ~+8.6 decades above target)
  Task  4: *** UNSOLVED *** — best=2.970e+00 by original.py               (target=1e-08, ~+8.5 decades above target)

PER-TASK BENCHMARK ERRORS (raw numbers, lower is better):
Task original.py           variant_01_catA_idea  variant_02_catB_idea  
-----------------------------------------------------------------------
0    1.4644e+01            -inf                  -inf                  
1    1.0636e+01            -inf                  -inf                  
2    1.3771e+02            -inf                  -inf                  
3    3.6282e+01            -inf                  -inf                  
4    2.9699e+00            -inf                  -inf                  
5    1.8968e+05            -inf                  -inf                  
6    5.9515e+02            -inf                  -inf                  
7    3.5131e+01            -inf                  -inf                  
8    1.0651e+01            -inf                  -inf                  
9    4.9747e+01            -inf                  -inf                  
10   2.3679e+01            -inf                  -inf                  
11   6.8246e+02            -inf                  -inf                  
12   2.2484e+01            -inf                  -inf                  
13   2.7853e+01            -inf                  -inf                  
14   6.1976e+00            -inf                  -inf                  
15   3.9030e+00            -inf                  -inf                  
16   4.0366e+03            -inf                  -inf                  
17   1.7682e+05            -inf                  -inf                  
18   7.5840e+01            -inf                  -inf                  
19   1.6550e+02            -inf                  -inf                  
20   2.0189e+01            -inf                  -inf                  
21   5.8873e+00            -inf                  -inf                  
22   1.7203e+01            -inf                  -inf                  
23   3.7589e+01            -inf                  -inf                  

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task  5: best error so far = 1.897e+05  (target = 1e-08)
  Task 17: best error so far = 1.768e+05  (target = 1e-08)
  Task 16: best error so far = 4.037e+03  (target = 1e-08)
  Task 11: best error so far = 6.825e+02  (target = 1e-08)
  Task  6: best error so far = 5.951e+02  (target = 1e-08)
  Task 19: best error so far = 1.655e+02  (target = 1e-08)
  Task  2: best error so far = 1.377e+02  (target = 1e-08)
  Task 18: best error so far = 7.584e+01  (target = 1e-08)
