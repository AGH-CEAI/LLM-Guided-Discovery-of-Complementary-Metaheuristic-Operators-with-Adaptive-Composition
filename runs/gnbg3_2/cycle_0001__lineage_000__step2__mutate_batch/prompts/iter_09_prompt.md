This is iteration 9 of 10. Propose ONE replacement implementation for `_mutate_batch`.
...
UNSOLVED TASKS (worst best-error first — these are the priority targets):
  ...
  Task 16: *** UNSOLVED *** — best=4.206e+03 by variant_08_catH_idea_0.py (target=1e-08, ~+11.6 decades above target)
  Task 11: *** UNSOLVED *** — best=2.815e+02 by variant_08_catH_idea_0.py (target=1e-08, ~+10.4 decades above target)
  Task  6: *** UNSOLVED *** — best=1.259e+02 by original.py               (target=1e-08, ~+10.1 decades above target)
  Task 19: *** UNSOLVED *** — best=1.090e+02 by variant_08_catH_idea_0.py (target=1e-08, ~+10.0 decades above target)
  Task 18: *** UNSOLVED *** — best=5.791e+01 by original.py               (target=1e-08, ~+9.8 decades above target)
  Task 23: *** UNSOLVED *** — best=4.748e+01 by original.py               (target=1e-08, ~+9.7 decades above target)
  Task  9: *** UNSOLVED *** — best=4.033e+01 by original.py               (target=1e-08, ~+9.6 decades above target)
  Task 13: *** UNSOLVED *** — best=2.745e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.4 decades above target)
  Task 20: *** UNSOLVED *** — best=2.043e+01 by original.py               (target=1e-08, ~+9.3 decades above target)
  Task  5: *** UNSOLVED *** — best=1.604e+01 by variant_05_catE_idea_0.py (target=1e-08, ~+9.2 decades above target)
  Task 22: *** UNSOLVED *** — best=1.107e+01 by variant_08_catH_idea_0.py (target=1e-08, ~+9.0 decades above target)
  Task 14: *** UNSOLVED *** — best=5.635e+00 by variant_08_catH_idea_0.py (target=1e-08, ~+8.8 decades above target)
  Task 21: *** UNSOLVED *** — best=5.241e+00 by variant_08_catH_idea_0.py (target=1e-08, ~+8.7 decades above target)
  Task  1: *** UNSOLVED *** — best=3.761e+00 by original.py               (target=1e-08, ~+8.6 decades above target)
  Task 15: *** UNSOLVED *** — best=3.407e+00 by variant_08_catH_idea_0.py (target=1e-08, ~+8.5 decades above target)
  Task  7: *** UNSOLVED *** — best=3.273e+00 by variant_05_catE_idea_0.py (target=1e-08, ~+8.5 decades above target)
  Task  3: *** UNSOLVED *** — best=2.615e+00 by variant_05_catE_idea_0.py (target=1e-08, ~+8.4 decades above target)
  Task  8: *** UNSOLVED *** — best=2.226e+00 by variant_05_catE_idea_0.py (target=1e-08, ~+8.3 decades above target)
  Task 10: *** UNSOLVED *** — best=1.263e+00 by original.py               (target=1e-08, ~+8.1 decades above target)
  Task 12: *** UNSOLVED *** — best=1.091e+00 by variant_05_catE_idea_0.py (target=1e-08, ~+8.0 decades above target)
  Task  4: *** UNSOLVED *** — best=9.950e-01 by original.py               (target=1e-08, ~+8.0 decades above target)
  Task  2: *** UNSOLVED *** — best=7.426e-05 by original.py               (target=1e-08, ~+3.9 decades above target)
  Task  0: *** UNSOLVED *** — best=1.148e-07 by original.py               (target=1e-08, ~+1.1 decades above target)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
0    1.1484e-07            6.6830e+00            -inf                  nan                   1.2951e-04            7.0815e-03            5.4160e-01            -inf                  1.4798e+00            
1    3.7609e+00            1.6343e+01            -inf                  nan                   4.0276e+00            3.7844e+00            1.1432e+01            -inf                  2.0439e+01            
2    7.4256e-05            3.7677e+01            -inf                  nan                   9.7938e-01            3.3835e-01            7.5423e+00            -inf                  1.1279e+00            
3    2.7695e+00            7.3357e+01            -inf                  nan                   2.2474e+01            2.6149e+00            5.3917e+01            -inf                  4.6816e+01            
4    9.9497e-01            2.7386e+00            -inf                  nan                   1.2330e+00            1.1923e+00            1.8854e+00            -inf                  4.1976e+00            
5    2.7027e+01            1.0161e+06            -inf                  nan                   4.7130e+03            1.6039e+01            4.1793e+05            -inf                  2.8173e+05            
6    1.2587e+02            6.8095e+02            -inf                  nan                   1.0955e+03            6.5217e+02            7.6656e+02            -inf                  5.6385e+02            
7    5.6617e+00            5.3725e+01            -inf                  nan                   1.9343e+01            3.2730e+00            5.5515e+01            -inf                  1.9768e+02            
8    2.3642e+00            1.3983e+01            -inf                  nan                   5.2699e+00            2.2259e+00            1.0790e+01            -inf                  1.6203e+01            
9    4.0335e+01            6.9860e+01            -inf                  nan                   1.7213e+02            4.2119e+01            1.0650e+02            -inf                  1.1495e+02            
10   1.2631e+00            4.0008e+02            -inf                  nan                   2.2674e+00            1.3095e+00            7.0748e+01            -inf                  1.8225e+01            
11   3.5466e+02            1.8137e+03            -inf                  nan                   6.8503e+02            5.3206e+02            1.0390e+03            -inf                  2.8154e+02            
12   2.5253e+00            2.5812e+02            -inf                  nan                   2.9135e+00            1.0910e+00            6.9299e+01            -inf                  3.5200e+01            
13   3.1412e+01            6.3531e+01            -inf                  nan                   2.7915e+01            3.4769e+01            4.5203e+01            -inf                  2.7449e+01            
14   7.2614e+00            2.1404e+01            -inf                  nan                   1.6215e+01            7.2028e+00            1.5416e+01            -inf                  5.6348e+00            
15   3.6149e+00            4.3257e+00            -inf                  nan                   4.0869e+00            3.8287e+00            4.1314e+00            -inf                  3.4070e+00            
16   4.8573e+03            4.8404e+04            -inf                  nan                   1.0593e+04            4.6734e+03            1.1410e+04            -inf                  4.2056e+03            
17   6.4095e+04            3.9865e+05            -inf                  nan                   7.3137e+04            1.5081e+05            2.9040e+05            -inf                  8.9194e+04            
18   5.7908e+01            1.0661e+02            -inf                  nan                   6.0289e+01            7.3558e+01            9.1703e+01            -inf                  6.0519e+01            
19   1.4621e+02            5.8939e+02            -inf                  nan                   3.9459e+02            1.7146e+02            3.5827e+02            -inf                  1.0905e+02            
20   2.0430e+01            7.0216e+01            -inf                  nan                   3.3058e+01            2.3141e+01            3.6874e+01            -inf                  4.5010e+01            
21   5.7073e+00            6.1184e+00            -inf                  nan                   5.7492e+00            5.7951e+00            6.0299e+00            -inf                  5.2407e+00            
22   1.3343e+01            2.3471e+01            -inf                  nan                   1.9860e+01            1.6531e+01            2.0174e+01            -inf                  1.1073e+01            
23   4.7477e+01            1.6396e+02            -inf                  nan                   1.0394e+02            6.9318e+01            8.9528e+01            -inf                  6.6228e+01            

PRIORITY TARGETS — UNSOLVED TASKS, WORST FIRST (drive these toward 1e-08):
  Task 17: best error so far = 6.410e+04  (target = 1e-08)
  Task 16: best error so far = 4.206e+03  (target = 1e-08)
  Task 11: best error so far = 2.815e+02  (target = 1e-08)
  Task  6: best error so far = 1.259e+02  (target = 1e-08)
  Task 19: best error so far = 1.090e+02  (target = 1e-08)
  Task 18: best error so far = 5.791e+01  (target = 1e-08)
  Task 23: best error so far = 4.748e+01  (target = 1e-08)
  Task  9: best error so far = 4.033e+01  (target = 1e-08)
