...
- AdaptiveCMAESWithRestarts
- TopologyAdaptivePSO
 
FEEDBACK FROM PREVIOUS RUNS (use this to design a better algorithm):
Best algorithm so far: geomean = 2.572775e-02
  from lineage 0, cycle 1

Per-task errors of the best algorithm (lower = better):
  Tasks with high error are where you should focus improvement.
  Task  0: error=1.157e-07
  Task  1: error=2.220e-07
  Task  2: error=2.445e-05
  Task  3: error=3.163e-04
  Task  4: error=2.440e-02
  Task  5: SOLVED  (error=1.00e-08)
  Task  6: error=5.437e-07
  Task  7: error=1.337e-05
  Task  8: error=1.730e-03
  Task  9: error=4.724e-04
  Task 10: error=4.815e+00  *** NEEDS IMPROVEMENT ***
  Task 11: error=3.698e+00  *** NEEDS IMPROVEMENT ***
  Task 12: error=1.681e+00  *** NEEDS IMPROVEMENT ***
  Task 13: error=1.016e+00  *** NEEDS IMPROVEMENT ***
  Task 14: error=2.535e+00  *** NEEDS IMPROVEMENT ***
  Task 15: error=1.144e+00  *** NEEDS IMPROVEMENT ***
  Task 16: error=8.782e+02  *** NEEDS IMPROVEMENT ***
  Task 17: error=3.120e+00  *** NEEDS IMPROVEMENT ***
  Task 18: error=2.674e+00  *** NEEDS IMPROVEMENT ***
  Task 19: error=1.021e+02  *** NEEDS IMPROVEMENT ***
  Task 20: error=5.505e+00  *** NEEDS IMPROVEMENT ***
  Task 21: error=4.508e+00  *** NEEDS IMPROVEMENT ***
  Task 22: error=2.337e+00  *** NEEDS IMPROVEMENT ***
  Task 23: error=6.419e+00  *** NEEDS IMPROVEMENT ***

History stats: 3 cycles, 2 improvements, 0 crashes
